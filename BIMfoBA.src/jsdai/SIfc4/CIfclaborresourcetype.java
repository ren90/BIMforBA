...
// Java class implementing entity IfcLaborResourceType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfclaborresourcetype extends CIfcconstructionresourcetype implements EIfclaborresourcetype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfclaborresourcetype.class, SIfc4.ss);
...
/*
	...
	protected int a11; // PredefinedType - current entity - ENUMERATION IfcLaborResourceTypeEnum
...
*/
	...
	//going through all the attributes: #4532=EXPLICIT_ATTRIBUTE('PredefinedType',#4530,0,#2907,$,.F.);
	...
	public boolean testPredefinedtype(EIfclaborresourcetype type) throws SdaiException {
		return test_enumeration(a11);
	}
	public int getPredefinedtype(EIfclaborresourcetype type) throws SdaiException {
		return get_enumeration(a11);
	}
	public void setPredefinedtype(EIfclaborresourcetype type, int value) throws SdaiException {
		a11 = set_enumeration(value, a11$);
	}
	public void unsetPredefinedtype(EIfclaborresourcetype type) throws SdaiException {
		a11 = unset_enumeration();
	}
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfclaborresourcetype type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a11 = av.entityValues[1].getEnumeration(0, a11$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcLaborResourceType
		av.entityValues[1].setEnumeration(0, a11, a11$);
...
*/
	...
	public int rIfclaborresourcetypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLaborResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLaborResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLaborResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLaborResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfclaborresourcetype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfctyperesource.class).getAttribute(jsdai.SIfc4.CIfctyperesource.attributeResourcetype(null), _context))))).getLogical());
	}
}
