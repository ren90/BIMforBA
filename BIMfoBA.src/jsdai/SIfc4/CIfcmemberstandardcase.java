...
// Java class implementing entity IfcMemberStandardCase

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcmemberstandardcase extends CIfcmember implements EIfcmemberstandardcase {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcmemberstandardcase.class, SIfc4.ss);
...
/*
	...
	// PredefinedType: protected int a8;   PredefinedType - java inheritance - ENUMERATION IfcMemberTypeEnum
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcMemberStandardCase
...
*/
	...
	public int rIfcmemberstandardcaseHasmaterialprofilesetusage(SdaiContext _context) throws SdaiException {
	


									
									Value _internal_aggregate_source128 = Value.alloc(ExpressTypes.BAG_GENERIC_TYPE).usedIn(Value.alloc(jsdai.SIfc4.CIfcmemberstandardcase.definition).set(_context, this), Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATES.RELATEDOBJECTS", "IFC4"));
									Value _result126 = Value.alloc(_internal_aggregate_source128).create();
									if (_internal_aggregate_source128.getActualJavaType() != Value.INDETERMINATE) {
										for (int _i127 = 1; _i127 <= _internal_aggregate_source128.getMemberCount(); _i127++) {
											Value _implicit_30_temp = _internal_aggregate_source128.getByIndex(_i127);
											if (Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATESMATERIAL", "IFC4"), _implicit_30_temp.typeOfV(_context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCMATERIALPROFILESETUSAGE", "IFC4"), _implicit_30_temp.getAttribute("RelatingMaterial", _context).typeOfV(_context))).getLogical() == 2) {
												_result126.addMember(_context, _implicit_30_temp);
											} else
											if (_internal_aggregate_source128.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
												_implicit_30_temp.unset();
												_result126.addMember(_context, _implicit_30_temp);
											}
										}
									} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt(_context, _result126), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1))).getLogical());
	}
}
