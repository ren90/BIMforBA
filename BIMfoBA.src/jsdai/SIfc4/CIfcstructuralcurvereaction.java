...
// Java class implementing entity IfcStructuralCurveReaction

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcstructuralcurvereaction extends CIfcstructuralreaction implements EIfcstructuralcurvereaction {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcstructuralcurvereaction.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcStructuralCurveActivityTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5830=EXPLICIT_ATTRIBUTE('PredefinedType',#5828,0,#3035,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcstructuralcurvereaction type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcStructuralCurveReaction
...
*/
	...
	public int rIfcstructuralcurvereactionSuitablepredefinedtype(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).setEnum(_context, "SINUS")), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).setEnum(_context, "PARABOLA")))).getLogical());
	}
	public int rIfcstructuralcurvereactionHasobjecttype(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcstructuralcurvereaction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context)))).getLogical());
	}
}
