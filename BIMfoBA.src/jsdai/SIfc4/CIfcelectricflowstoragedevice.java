...
// Java class implementing entity IfcElectricFlowStorageDevice

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcelectricflowstoragedevice extends CIfcflowstoragedevice implements EIfcelectricflowstoragedevice {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcelectricflowstoragedevice.class, SIfc4.ss);
...
/*
	...
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcElectricFlowStorageDeviceTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4114=EXPLICIT_ATTRIBUTE('PredefinedType',#4112,0,#2843,$,.T.);
	...
	public boolean testPredefinedtype(EIfcelectricflowstoragedevice type) throws SdaiException {
		return test_enumeration(a8);
	}
	public int getPredefinedtype(EIfcelectricflowstoragedevice type) throws SdaiException {
		return get_enumeration(a8);
	}
	public void setPredefinedtype(EIfcelectricflowstoragedevice type, int value) throws SdaiException {
		a8 = set_enumeration(value, a8$);
	}
	public void unsetPredefinedtype(EIfcelectricflowstoragedevice type) throws SdaiException {
		a8 = unset_enumeration();
	}
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcelectricflowstoragedevice type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a8 = av.entityValues[2].getEnumeration(0, a8$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcElectricFlowStorageDevice
		av.entityValues[2].setEnumeration(0, a8, a8$);
		// partial entity: IfcElement
		av.entityValues[3].setString(0, a7);
		// partial entity: IfcFlowStorageDevice
...
*/
	...
	public int rIfcelectricflowstoragedeviceCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCELECTRICFLOWSTORAGEDEVICETYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcelectricflowstoragedevice.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
	public int rIfcelectricflowstoragedeviceCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcElectricFlowStorageDeviceTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcElectricFlowStorageDeviceTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcElectricFlowStorageDeviceTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcElectricFlowStorageDeviceTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcElectricFlowStorageDeviceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcelectricflowstoragedevice.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
