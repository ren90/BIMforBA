...
// Java class implementing entity IfcConstructionEquipmentResource

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcconstructionequipmentresource extends CIfcconstructionresource implements EIfcconstructionequipmentresource {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcconstructionequipmentresource.class, SIfc4.ss);
...
/*
	...
	// Usage: protected Object a7;   Usage - java inheritance - ENTITY IfcResourceTime
	// BaseCosts: protected AIfcappliedvalue a8;   BaseCosts - java inheritance - LIST OF ENTITY
	// BaseQuantity: protected Object a9;   BaseQuantity - java inheritance - ENTITY IfcPhysicalQuantity
	protected int a10; // PredefinedType - current entity - ENUMERATION IfcConstructionEquipmentResourceTypeEnum
...
*/
	...
	// Usage - explicit - java inheritance
	// protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	// protected Object a7;
	// BaseCosts - explicit - java inheritance
	// protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	// protected AIfcappliedvalue a8;
	// BaseQuantity - explicit - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5562=EXPLICIT_ATTRIBUTE('Identification',#5560,0,#2523,$,.T.);
	//<01> generating methods for consolidated attribute:  Identification
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5563=EXPLICIT_ATTRIBUTE('LongDescription',#5560,1,#2657,$,.T.);
	//<01> generating methods for consolidated attribute:  LongDescription
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5564=INVERSE_ATTRIBUTE('ResourceOf',#5560,0,#5372,$,#5374,#9235,$,.F.);
	//<01> generating methods for consolidated attribute:  ResourceOf
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3776=EXPLICIT_ATTRIBUTE('Usage',#3774,0,#5577,$,.T.);
	//<01> generating methods for consolidated attribute:  Usage
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	// attribute (java explicit): Usage, base type: entity IfcResourceTime
	public static int usedinUsage(EIfcconstructionresource type, EIfcresourcetime instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a7$, domain, result);
	}
	//going through all the attributes: #3777=EXPLICIT_ATTRIBUTE('BaseCosts',#3774,1,#6874,$,.T.);
	//<01> generating methods for consolidated attribute:  BaseCosts
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	// methods for attribute: BaseCosts, base type: LIST OF ENTITY
	public static int usedinBasecosts(EIfcconstructionresource type, EIfcappliedvalue instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a8$, domain, result);
	}
	//going through all the attributes: #3778=EXPLICIT_ATTRIBUTE('BaseQuantity',#3774,2,#4916,$,.T.);
	//<01> generating methods for consolidated attribute:  BaseQuantity
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	// attribute (java explicit): BaseQuantity, base type: entity IfcPhysicalQuantity
	public static int usedinBasequantity(EIfcconstructionresource type, EIfcphysicalquantity instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a9$, domain, result);
	}
	//going through all the attributes: #3758=EXPLICIT_ATTRIBUTE('PredefinedType',#3756,0,#2777,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcconstructionequipmentresource type) throws SdaiException {
		return a10$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a10 = av.entityValues[0].getEnumeration(0, a10$);
		a7 = av.entityValues[1].getInstance(0, this, a7$);
		a8 = (AIfcappliedvalue)av.entityValues[1].getInstanceAggregate(1, a8$, this);
		a9 = av.entityValues[1].getInstance(2, this, a9$);
		a4 = av.entityValues[2].getString(0);
		a5 = av.entityValues[4].getString(0);
		a6 = av.entityValues[4].getString(1);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcConstructionEquipmentResource
		av.entityValues[0].setEnumeration(0, a10, a10$);
		// partial entity: IfcConstructionResource
		av.entityValues[1].setInstance(0, a7);
		av.entityValues[1].setInstanceAggregate(1, a8);
		av.entityValues[1].setInstance(2, a9);
		// partial entity: IfcObject
		av.entityValues[2].setString(0, a4);
		// partial entity: IfcObjectDefinition
		// partial entity: IfcResource
		av.entityValues[4].setString(0, a5);
		av.entityValues[4].setString(1, a6);
...
*/
	...
	public int rIfcconstructionequipmentresourceCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionEquipmentResourceTypeEnum).set(_context, get(a10$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionEquipmentResourceTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionEquipmentResourceTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionEquipmentResourceTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionEquipmentResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcconstructionequipmentresource.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
