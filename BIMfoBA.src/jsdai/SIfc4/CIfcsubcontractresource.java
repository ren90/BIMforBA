...
// Java class implementing entity IfcSubContractResource

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcsubcontractresource extends CIfcconstructionresource implements EIfcsubcontractresource {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcsubcontractresource.class, SIfc4.ss);
...
/*
	...
	protected int a10; // PredefinedType - current entity - ENUMERATION IfcSubContractResourceTypeEnum
...
*/
	...
	//going through all the attributes: #5945=EXPLICIT_ATTRIBUTE('PredefinedType',#5943,0,#3043,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcsubcontractresource type) throws SdaiException {
		return a10$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a10 = av.entityValues[5].getEnumeration(0, a10$);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcSubContractResource
		av.entityValues[5].setEnumeration(0, a10, a10$);
	}
*/
	...
	public int rIfcsubcontractresourceCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSubContractResourceTypeEnum).set(_context, get(a10$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSubContractResourceTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSubContractResourceTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSubContractResourceTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSubContractResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcsubcontractresource.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
