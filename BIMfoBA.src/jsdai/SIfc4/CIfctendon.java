...
// Java class implementing entity IfcTendon

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfctendon extends CIfcreinforcingelement implements EIfctendon {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfctendon.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcTendonTypeEnum
...
*/
	...
	// TensionForce - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a12$ = CEntity.initExplicitAttribute(definition, 12);
	protected double a12;
	// PreStress - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a13$ = CEntity.initExplicitAttribute(definition, 13);
	protected double a13;
	// FrictionCoefficient - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a14$ = CEntity.initExplicitAttribute(definition, 14);
	protected double a14;
	// AnchorageSlip - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a15$ = CEntity.initExplicitAttribute(definition, 15);
	protected double a15;
	// MinCurvatureRadius - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a16$ = CEntity.initExplicitAttribute(definition, 16);
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6131=EXPLICIT_ATTRIBUTE('PredefinedType',#6129,0,#3061,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfctendon type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #6132=EXPLICIT_ATTRIBUTE('NominalDiameter',#6129,1,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeNominaldiameter(EIfctendon type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #6133=EXPLICIT_ATTRIBUTE('CrossSectionArea',#6129,2,#2457,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeCrosssectionarea(EIfctendon type) throws SdaiException {
		return a11$;
	}

	//going through all the attributes: #6134=EXPLICIT_ATTRIBUTE('TensionForce',#6129,3,#2513,$,.T.);
	//<01> generating methods for consolidated attribute:  TensionForce
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeTensionforce(EIfctendon type) throws SdaiException {
		return a12$;
	}

	//going through all the attributes: #6135=EXPLICIT_ATTRIBUTE('PreStress',#6129,4,#2615,$,.T.);
	//<01> generating methods for consolidated attribute:  PreStress
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributePrestress(EIfctendon type) throws SdaiException {
		return a13$;
	}

	//going through all the attributes: #6136=EXPLICIT_ATTRIBUTE('FrictionCoefficient',#6129,5,#2593,$,.T.);
	//<01> generating methods for consolidated attribute:  FrictionCoefficient
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeFrictioncoefficient(EIfctendon type) throws SdaiException {
		return a14$;
	}

	//going through all the attributes: #6137=EXPLICIT_ATTRIBUTE('AnchorageSlip',#6129,6,#2605,$,.T.);
	//<01> generating methods for consolidated attribute:  AnchorageSlip
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeAnchorageslip(EIfctendon type) throws SdaiException {
		return a15$;
	}

	//going through all the attributes: #6138=EXPLICIT_ATTRIBUTE('MinCurvatureRadius',#6129,7,#2605,$,.T.);
	//<01> generating methods for consolidated attribute:  MinCurvatureRadius
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeMincurvatureradius(EIfctendon type) throws SdaiException {
		return a16$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a9 = av.entityValues[7].getEnumeration(0, a9$);
		a10 = av.entityValues[7].getDouble(1);
		a11 = av.entityValues[7].getDouble(2);
		a12 = av.entityValues[7].getDouble(3);
		a13 = av.entityValues[7].getDouble(4);
		a14 = av.entityValues[7].getDouble(5);
		a15 = av.entityValues[7].getDouble(6);
		a16 = av.entityValues[7].getDouble(7);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcTendon
		av.entityValues[7].setEnumeration(0, a9, a9$);
		av.entityValues[7].setDouble(1, a10);
		av.entityValues[7].setDouble(2, a11);
		av.entityValues[7].setDouble(3, a12);
		av.entityValues[7].setDouble(4, a13);
		av.entityValues[7].setDouble(5, a14);
		av.entityValues[7].setDouble(6, a15);
		av.entityValues[7].setDouble(7, a16);
	}
*/
	...
	public int rIfctendonCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTendonTypeEnum).set(_context, get(a9$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTendonTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTendonTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTendonTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTendonTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfctendon.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
	public int rIfctendonCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCTENDONTYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfctendon.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
}
