...
// Java class implementing entity IfcQuantityCount

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcquantitycount extends CIfcphysicalsimplequantity implements EIfcquantitycount {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcquantitycount.class, SIfc4.ss);
...
/*
	...
	protected double a3; // CountValue - current entity - NUMBER
...
*/
	...
	// protected Object a2;
	// CountValue - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a3$ = CEntity.initExplicitAttribute(definition, 3);
	protected double a3;
...
*/
	...
	//going through all the attributes: #5197=EXPLICIT_ATTRIBUTE('CountValue',#5195,0,#2471,$,.F.);
	//<01> generating methods for consolidated attribute:  CountValue
	//<01-0> current entity
	...
	public static jsdai.dictionary.EAttribute attributeCountvalue(EIfcquantitycount type) throws SdaiException {
		return a3$;
	}

	//going through all the attributes: #5198=EXPLICIT_ATTRIBUTE('Formula',#5195,1,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeFormula(EIfcquantitycount type) throws SdaiException {
		return a4$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcQuantityCount
...
*/
	...
	public int rIfcquantitycountWr21(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).gequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCountMeasure).set(_context, get(a3$)), Value.alloc(ExpressTypes.REAL_TYPE).set(_context, 0.0))).getLogical());
	}
}
