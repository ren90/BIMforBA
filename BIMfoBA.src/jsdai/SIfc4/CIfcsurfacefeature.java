...
// Java class implementing entity IfcSurfaceFeature

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcsurfacefeature extends CIfcfeatureelement implements EIfcsurfacefeature {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcsurfacefeature.class, SIfc4.ss);
...
/*
	...
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcSurfaceFeatureTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5963=EXPLICIT_ATTRIBUTE('PredefinedType',#5961,0,#3045,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcsurfacefeature type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcSurfaceFeature
...
*/
	...
	public int rIfcsurfacefeatureHasobjecttype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSurfaceFeatureTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSurfaceFeatureTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSurfaceFeatureTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcsurfacefeature.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context)))).getLogical());
	}
}
