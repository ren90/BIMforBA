...
// Java class implementing entity IfcBeamStandardCase

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcbeamstandardcase extends CIfcbeam implements EIfcbeamstandardcase {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcbeamstandardcase.class, SIfc4.ss);
...
/*
	...
	// PredefinedType: protected int a8;   PredefinedType - java inheritance - ENUMERATION IfcBeamTypeEnum
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcBeamStandardCase
...
*/
	...
	public int rIfcbeamstandardcaseHasmaterialprofilesetusage(SdaiContext _context) throws SdaiException {
	


									
									Value _internal_aggregate_source55 = Value.alloc(ExpressTypes.BAG_GENERIC_TYPE).usedIn(Value.alloc(jsdai.SIfc4.CIfcbeamstandardcase.definition).set(_context, this), Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATES.RELATEDOBJECTS", "IFC4"));
									Value _result53 = Value.alloc(_internal_aggregate_source55).create();
									if (_internal_aggregate_source55.getActualJavaType() != Value.INDETERMINATE) {
										for (int _i54 = 1; _i54 <= _internal_aggregate_source55.getMemberCount(); _i54++) {
											Value _implicit_13_temp = _internal_aggregate_source55.getByIndex(_i54);
											if (Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATESMATERIAL", "IFC4"), _implicit_13_temp.typeOfV(_context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCMATERIALPROFILESETUSAGE", "IFC4"), _implicit_13_temp.getAttribute("RelatingMaterial", _context).typeOfV(_context))).getLogical() == 2) {
												_result53.addMember(_context, _implicit_13_temp);
											} else
											if (_internal_aggregate_source55.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
												_implicit_13_temp.unset();
												_result53.addMember(_context, _implicit_13_temp);
											}
										}
									} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt(_context, _result53), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1))).getLogical());
	}
}
