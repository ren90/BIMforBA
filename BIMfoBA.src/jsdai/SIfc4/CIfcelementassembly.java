...
// Java class implementing entity IfcElementAssembly

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcelementassembly extends CIfcelement implements EIfcelementassembly {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcelementassembly.class, SIfc4.ss);
...
/*
	...
	protected int a8; // AssemblyPlace - current entity - ENUMERATION IfcAssemblyPlaceEnum
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcElementAssemblyTypeEnum
...
*/
	...
	// AssemblyPlace - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected int a8;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4152=EXPLICIT_ATTRIBUTE('AssemblyPlace',#4150,0,#2723,$,.T.);
	//<01> generating methods for consolidated attribute:  AssemblyPlace
	//<01-0> current entity
	...
	public static jsdai.dictionary.EAttribute attributeAssemblyplace(EIfcelementassembly type) throws SdaiException {
		return a8$;
	}

	//going through all the attributes: #4153=EXPLICIT_ATTRIBUTE('PredefinedType',#4150,1,#2851,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcelementassembly type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a9 = av.entityValues[1].getEnumeration(1, a9$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcElementAssembly
		av.entityValues[1].setEnumeration(0, a8, a8$);
		av.entityValues[1].setEnumeration(1, a9, a9$);
...
*/
	...
	public int rIfcelementassemblyCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcElementAssemblyTypeEnum).set(_context, get(a9$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcElementAssemblyTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcElementAssemblyTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcElementAssemblyTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcElementAssemblyTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcelementassembly.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
