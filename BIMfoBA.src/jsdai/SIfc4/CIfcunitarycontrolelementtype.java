...
// Java class implementing entity IfcUnitaryControlElementType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcunitarycontrolelementtype extends CIfcdistributioncontrolelementtype implements EIfcunitarycontrolelementtype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcunitarycontrolelementtype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcUnitaryControlElementTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6309=EXPLICIT_ATTRIBUTE('PredefinedType',#6307,0,#3079,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcunitarycontrolelementtype type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcDistributionControlElementType
		...
		// partial entity: IfcUnitaryControlElementType
...
*/
	...
	public int rIfcunitarycontrolelementtypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryControlElementTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryControlElementTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryControlElementTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryControlElementTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcunitarycontrolelementtype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
