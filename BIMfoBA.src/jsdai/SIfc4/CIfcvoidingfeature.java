...
// Java class implementing entity IfcVoidingFeature

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcvoidingfeature extends CIfcfeatureelementsubtraction implements EIfcvoidingfeature {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcvoidingfeature.class, SIfc4.ss);
...
/*
	...
	// VoidsElements: protected Object  - inverse - java inheritance -  ENTITY IfcRelVoidsElement
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcVoidingFeatureTypeEnum
...
*/
	...
	// VoidsElements - inverse - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4304=INVERSE_ATTRIBUTE('VoidsElements',#4302,0,#5527,$,#5530,$,$,.F.);
	//<01> generating methods for consolidated attribute:  VoidsElements
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6349=EXPLICIT_ATTRIBUTE('PredefinedType',#6347,0,#3087,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcvoidingfeature type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcFeatureElement
		// partial entity: IfcFeatureElementSubtraction
		...
		// partial entity: IfcVoidingFeature
...
*/
	...
	public int rIfcvoidingfeatureHasobjecttype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcVoidingFeatureTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcVoidingFeatureTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcVoidingFeatureTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcvoidingfeature.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context)))).getLogical());
	}
}
