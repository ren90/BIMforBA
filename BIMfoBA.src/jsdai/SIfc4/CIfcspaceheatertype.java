...
// Java class implementing entity IfcSpaceHeaterType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcspaceheatertype extends CIfcflowterminaltype implements EIfcspaceheatertype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcspaceheatertype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcSpaceHeaterTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5742=EXPLICIT_ATTRIBUTE('PredefinedType',#5740,0,#3021,$,.F.);
	...
	public boolean testPredefinedtype(EIfcspaceheatertype type) throws SdaiException {
		return test_enumeration(a9);
	}
	public int getPredefinedtype(EIfcspaceheatertype type) throws SdaiException {
		return get_enumeration(a9);
	}
	public void setPredefinedtype(EIfcspaceheatertype type, int value) throws SdaiException {
		a9 = set_enumeration(value, a9$);
	}
	public void unsetPredefinedtype(EIfcspaceheatertype type) throws SdaiException {
		a9 = unset_enumeration();
	}
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcspaceheatertype type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcSpaceHeaterType
...
*/
	...
	public int rIfcspaceheatertypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpaceHeaterTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpaceHeaterTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpaceHeaterTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpaceHeaterTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcspaceheatertype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
