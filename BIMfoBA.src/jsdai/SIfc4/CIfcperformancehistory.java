...
// Java class implementing entity IfcPerformanceHistory

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcperformancehistory extends CIfccontrol implements EIfcperformancehistory {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcperformancehistory.class, SIfc4.ss);
...
/*
	...
	protected String a6; // LifeCyclePhase - current entity - STRING
	protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	protected int a7; // PredefinedType - current entity - ENUMERATION IfcPerformanceHistoryTypeEnum
...
*/
	...
	// LifeCyclePhase - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	protected String a6;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4880=EXPLICIT_ATTRIBUTE('LifeCyclePhase',#4878,0,#2539,$,.F.);
	//<01> generating methods for consolidated attribute:  LifeCyclePhase
	//<01-0> current entity
	...
	public static jsdai.dictionary.EAttribute attributeLifecyclephase(EIfcperformancehistory type) throws SdaiException {
		return a6$;
	}

	//going through all the attributes: #4881=EXPLICIT_ATTRIBUTE('PredefinedType',#4878,1,#2943,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcperformancehistory type) throws SdaiException {
		return a7$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a7 = av.entityValues[3].getEnumeration(1, a7$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcPerformanceHistory
		av.entityValues[3].setString(0, a6);
		av.entityValues[3].setEnumeration(1, a7, a7$);
