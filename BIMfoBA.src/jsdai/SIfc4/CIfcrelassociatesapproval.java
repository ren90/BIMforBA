...
// Java class implementing entity IfcRelAssociatesApproval

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcrelassociatesapproval extends CIfcrelassociates implements EIfcrelassociatesapproval {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcrelassociatesapproval.class, SIfc4.ss);
...
/*
	...
	protected Object a5; // RelatingApproval - current entity - ENTITY IfcApproval
...
*/
	...
	//going through all the attributes: #5380=EXPLICIT_ATTRIBUTE('RelatingApproval',#5378,0,#3314,$,.F.);
	...
	public static int usedinRelatingapproval(EIfcrelassociatesapproval type, EIfcapproval instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public EIfcapproval getRelatingapproval(EIfcrelassociatesapproval type) throws SdaiException {
		return (EIfcapproval)get_instance(a5);
	}
	...
	public static jsdai.dictionary.EAttribute attributeRelatingapproval(EIfcrelassociatesapproval type) throws SdaiException {
		return a5$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcRelAssociatesApproval
