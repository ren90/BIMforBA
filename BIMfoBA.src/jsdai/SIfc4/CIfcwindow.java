...
// Java class implementing entity IfcWindow

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcwindow extends CIfcbuildingelement implements EIfcwindow {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcwindow.class, SIfc4.ss);
...
*/
	...
	// OverallHeight - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected double a8;
	...
	protected static final jsdai.dictionary.CExplicit_attribute a10$ = CEntity.initExplicitAttribute(definition, 10);
	protected int a10;
	// PartitioningType - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a11$ = CEntity.initExplicitAttribute(definition, 11);
	protected int a11;
	// UserDefinedPartitioningType - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a12$ = CEntity.initExplicitAttribute(definition, 12);
...
*/
	...
	public static jsdai.dictionary.EAttribute attributeOverallheight(EIfcwindow type) throws SdaiException {
		return a8$;
	}
	...
	public static jsdai.dictionary.EAttribute attributeOverallwidth(EIfcwindow type) throws SdaiException {
		return a9$;
	}
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcwindow type) throws SdaiException {
		return a10$;
	}
	...
	public static jsdai.dictionary.EAttribute attributePartitioningtype(EIfcwindow type) throws SdaiException {
		return a11$;
	}
	...
	public static jsdai.dictionary.EAttribute attributeUserdefinedpartitioningtype(EIfcwindow type) throws SdaiException {
		return a12$;
	}
