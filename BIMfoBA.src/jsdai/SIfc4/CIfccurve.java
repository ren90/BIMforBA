...
// Java class implementing entity IfcCurve

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfccurve extends CIfcgeometricrepresentationitem implements EIfccurve {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfccurve.class, SIfc4.ss);
...
//###-01 jc.generated_java: (new jsdai.SIfc4.FIfccurvedim()).run(_context, Value.alloc(jsdai.SIfc4.CIfccurve.definition).set(_context, this))
				return ((new jsdai.SIfc4.FIfccurvedim()).run(_context, Value.alloc(jsdai.SIfc4.CIfccurve.definition).set(_context, this)));
	}
