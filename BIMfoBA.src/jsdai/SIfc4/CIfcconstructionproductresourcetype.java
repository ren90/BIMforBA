...
// Java class implementing entity IfcConstructionProductResourceType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcconstructionproductresourcetype extends CIfcconstructionresourcetype implements EIfcconstructionproductresourcetype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcconstructionproductresourcetype.class, SIfc4.ss);
...
/*
	...
	protected int a11; // PredefinedType - current entity - ENUMERATION IfcConstructionProductResourceTypeEnum
...
*/
	...
	//going through all the attributes: #3773=EXPLICIT_ATTRIBUTE('PredefinedType',#3771,0,#2781,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcconstructionproductresourcetype type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcConstructionProductResourceType
...
*/
	...
	public int rIfcconstructionproductresourcetypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionProductResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionProductResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionProductResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionProductResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcconstructionproductresourcetype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfctyperesource.class).getAttribute(jsdai.SIfc4.CIfctyperesource.attributeResourcetype(null), _context))))).getLogical());
	}
}
