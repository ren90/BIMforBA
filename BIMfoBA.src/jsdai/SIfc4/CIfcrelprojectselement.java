...
// Java class implementing entity IfcRelProjectsElement

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcrelprojectselement extends CIfcreldecomposes implements EIfcrelprojectselement {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcrelprojectselement.class, SIfc4.ss);
...
/*
	...
	protected Object a5; // RelatedFeatureElement - current entity - ENTITY IfcFeatureElementAddition
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a4$ = CEntity.initExplicitAttribute(definition, 4);
	protected Object a4;
	// RelatedFeatureElement - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a5$ = CEntity.initExplicitAttribute(definition, 5);
	protected Object a5;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5495=EXPLICIT_ATTRIBUTE('RelatingElement',#5493,0,#4136,$,.F.);
	...
	public static int usedinRelatingelement(EIfcrelprojectselement type, EIfcelement instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static jsdai.dictionary.EAttribute attributeRelatingelement(EIfcrelprojectselement type) throws SdaiException {
		return a4$;
	}

	//going through all the attributes: #5496=EXPLICIT_ATTRIBUTE('RelatedFeatureElement',#5493,1,#4299,$,.F.);
	//<01> generating methods for consolidated attribute:  RelatedFeatureElement
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// attribute (current explicit or supertype explicit) : RelatedFeatureElement, base type: entity IfcFeatureElementAddition
	public static int usedinRelatedfeatureelement(EIfcrelprojectselement type, EIfcfeatureelementaddition instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public EIfcfeatureelementaddition getRelatedfeatureelement(EIfcrelprojectselement type) throws SdaiException {
		return (EIfcfeatureelementaddition)get_instance(a5);
	}
	...
	public static jsdai.dictionary.EAttribute attributeRelatedfeatureelement(EIfcrelprojectselement type) throws SdaiException {
		return a5$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcRelProjectsElement
