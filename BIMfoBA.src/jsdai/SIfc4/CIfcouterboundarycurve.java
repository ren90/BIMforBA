...
// Java class implementing entity IfcOuterBoundaryCurve

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcouterboundarycurve extends CIfcboundarycurve implements EIfcouterboundarycurve {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcouterboundarycurve.class, SIfc4.ss);
...
//###-01 jc.generated_java: (new jsdai.SIfc4.FIfccurvedim()).run(_context, Value.alloc(jsdai.SIfc4.CIfcouterboundarycurve.definition).set(_context, this))
				return ((new jsdai.SIfc4.FIfccurvedim()).run(_context, Value.alloc(jsdai.SIfc4.CIfcouterboundarycurve.definition).set(_context, this)));
	}
...
//###-01 jc.generated_java: (new jsdai.SIfc4.FIfcgetbasissurface()).run(_context, Value.alloc(jsdai.SIfc4.CIfcouterboundarycurve.definition).set(_context, this))
				return ((new jsdai.SIfc4.FIfcgetbasissurface()).run(_context, Value.alloc(jsdai.SIfc4.CIfcouterboundarycurve.definition).set(_context, this)));
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcOuterBoundaryCurve
