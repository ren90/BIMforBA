...
// Java class implementing entity IfcSystem

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcsystem extends CIfcgroup implements EIfcsystem {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcsystem.class, SIfc4.ss);
...
/*
	...
	// ServicesBuildings: protected Object  - inverse - current -  ENTITY IfcRelServicesBuildings
...
*/
	...
	// ServicesBuildings - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i12$ = CEntity.initInverseAttribute(definition, 12);
...
*/
	...
	public AIfcrelservicesbuildings getServicesbuildings(EIfcsystem type, ASdaiModel domain) throws SdaiException {
		AIfcrelservicesbuildings result = (AIfcrelservicesbuildings)get_inverse_aggregate(i12$);
		CIfcrelservicesbuildings.usedinRelatingsystem(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeServicesbuildings(EIfcsystem type) throws SdaiException {
		return i12$;
	}
