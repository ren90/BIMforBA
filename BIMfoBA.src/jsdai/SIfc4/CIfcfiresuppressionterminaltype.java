...
// Java class implementing entity IfcFireSuppressionTerminalType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcfiresuppressionterminaltype extends CIfcflowterminaltype implements EIfcfiresuppressionterminaltype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcfiresuppressionterminaltype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcFireSuppressionTerminalTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4332=EXPLICIT_ATTRIBUTE('PredefinedType',#4330,0,#2873,$,.F.);
	...
	public boolean testPredefinedtype(EIfcfiresuppressionterminaltype type) throws SdaiException {
		return test_enumeration(a9);
	}
	public int getPredefinedtype(EIfcfiresuppressionterminaltype type) throws SdaiException {
		return get_enumeration(a9);
	}
	public void setPredefinedtype(EIfcfiresuppressionterminaltype type, int value) throws SdaiException {
		a9 = set_enumeration(value, a9$);
	}
	public void unsetPredefinedtype(EIfcfiresuppressionterminaltype type) throws SdaiException {
		a9 = unset_enumeration();
	}
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcfiresuppressionterminaltype type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcFireSuppressionTerminalType
...
*/
	...
	public int rIfcfiresuppressionterminaltypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFireSuppressionTerminalTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFireSuppressionTerminalTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFireSuppressionTerminalTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFireSuppressionTerminalTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcfiresuppressionterminaltype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
