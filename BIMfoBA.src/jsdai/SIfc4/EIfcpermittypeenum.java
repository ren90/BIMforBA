...
// Java class implementing enumeration IfcPermitTypeEnum

package jsdai.SIfc4;
import jsdai.lang.*;

public class EIfcpermittypeenum {

	private static final int unset = 0;
	public static final int ACCESS = 1;	// ACCESS
	public static final int BUILDING = 2;	// BUILDING
	public static final int WORK = 3;	// WORK
	public static final int USERDEFINED = 4;	// USERDEFINED
	public static final int NOTDEFINED = 5;	// NOTDEFINED

	private static final int dim = 5;

	public static final String values[] = {"ACCESS", "BUILDING", "WORK", "USERDEFINED", "NOTDEFINED"};
