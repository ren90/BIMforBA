...
// Java class implementing entity IfcWallStandardCase

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcwallstandardcase extends CIfcwall implements EIfcwallstandardcase {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcwallstandardcase.class, SIfc4.ss);
...
/*
	...
	// PredefinedType: protected int a8;   PredefinedType - java inheritance - ENUMERATION IfcWallTypeEnum
*/
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6352=EXPLICIT_ATTRIBUTE('PredefinedType',#6350,0,#3089,$,.T.);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcWall
		av.entityValues[6].setEnumeration(0, a8, a8$);
		// partial entity: IfcWallStandardCase
	}
*/
	...
	public int rIfcwallstandardcaseHasmateriallayersetusage(SdaiContext _context) throws SdaiException {
	


									
									Value _internal_aggregate_source334 = Value.alloc(ExpressTypes.BAG_GENERIC_TYPE).usedIn(Value.alloc(jsdai.SIfc4.CIfcwallstandardcase.definition).set(_context, this), Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATES.RELATEDOBJECTS", "IFC4"));
									Value _result332 = Value.alloc(_internal_aggregate_source334).create();
									if (_internal_aggregate_source334.getActualJavaType() != Value.INDETERMINATE) {
										for (int _i333 = 1; _i333 <= _internal_aggregate_source334.getMemberCount(); _i333++) {
											Value _implicit_78_temp = _internal_aggregate_source334.getByIndex(_i333);
											if (Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATESMATERIAL", "IFC4"), _implicit_78_temp.typeOfV(_context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCMATERIALLAYERSETUSAGE", "IFC4"), _implicit_78_temp.getAttribute("RelatingMaterial", _context).typeOfV(_context))).getLogical() == 2) {
												_result332.addMember(_context, _implicit_78_temp);
											} else
											if (_internal_aggregate_source334.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
												_implicit_78_temp.unset();
												_result332.addMember(_context, _implicit_78_temp);
											}
										}
									} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt(_context, _result332), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1))).getLogical());
	}
}
