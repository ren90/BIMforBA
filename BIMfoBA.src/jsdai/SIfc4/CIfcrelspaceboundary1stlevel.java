...
// Java class implementing entity IfcRelSpaceBoundary1stLevel

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcrelspaceboundary1stlevel extends CIfcrelspaceboundary implements EIfcrelspaceboundary1stlevel {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcrelspaceboundary1stlevel.class, SIfc4.ss);
...
/*
	...
	protected Object a9; // ParentBoundary - current entity - ENTITY IfcRelSpaceBoundary1stLevel
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	// InnerBoundaries: protected Object  - inverse - current -  ENTITY IfcRelSpaceBoundary1stLevel
...
*/
	...
	// protected int a8;
	// ParentBoundary - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected Object a9;
	// InnerBoundaries - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i0$ = CEntity.initInverseAttribute(definition, 0);
...
*/
	...
	// attribute (current explicit or supertype explicit) : ParentBoundary, base type: entity IfcRelSpaceBoundary1stLevel
	...
	public EIfcrelspaceboundary1stlevel getParentboundary(EIfcrelspaceboundary1stlevel type) throws SdaiException {
		return (EIfcrelspaceboundary1stlevel)get_instance(a9);
	}
	...
	public static jsdai.dictionary.EAttribute attributeParentboundary(EIfcrelspaceboundary1stlevel type) throws SdaiException {
		return a9$;
	}
	...
	public AIfcrelspaceboundary1stlevel getInnerboundaries(EIfcrelspaceboundary1stlevel type, ASdaiModel domain) throws SdaiException {
		AIfcrelspaceboundary1stlevel result = (AIfcrelspaceboundary1stlevel)get_inverse_aggregate(i0$);
		CIfcrelspaceboundary1stlevel.usedinParentboundary(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeInnerboundaries(EIfcrelspaceboundary1stlevel type) throws SdaiException {
		return i0$;
	}
