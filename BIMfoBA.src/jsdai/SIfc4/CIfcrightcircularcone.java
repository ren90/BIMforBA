...
// Java class implementing entity IfcRightCircularCone

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcrightcircularcone extends CIfccsgprimitive3d implements EIfcrightcircularcone {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcrightcircularcone.class, SIfc4.ss);
...
/*
	...
	protected double a1; // Height - current entity - REAL
	protected static final jsdai.dictionary.CExplicit_attribute a1$ = CEntity.initExplicitAttribute(definition, 1);
	protected double a2; // BottomRadius - current entity - REAL
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a1$ = CEntity.initExplicitAttribute(definition, 1);
	protected double a1;
	// BottomRadius - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a2$ = CEntity.initExplicitAttribute(definition, 2);
	protected double a2;
...
//###-01 jc.generated_java: Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 3)
	...
	//going through all the attributes: #5604=EXPLICIT_ATTRIBUTE('Height',#5602,0,#2605,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeHeight(EIfcrightcircularcone type) throws SdaiException {
		return a1$;
	}

	//going through all the attributes: #5605=EXPLICIT_ATTRIBUTE('BottomRadius',#5602,1,#2605,$,.F.);
	//<01> generating methods for consolidated attribute:  BottomRadius
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeBottomradius(EIfcrightcircularcone type) throws SdaiException {
		return a2$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcRightCircularCone
