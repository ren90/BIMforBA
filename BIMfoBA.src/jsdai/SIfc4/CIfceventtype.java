...
// Java class implementing entity IfcEventType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfceventtype extends CIfctypeprocess implements EIfceventtype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfceventtype.class, SIfc4.ss);
...
/*
	...
	// ProcessType: protected String a8;   ProcessType - java inheritance - STRING
	// OperatesOn: protected Object  - inverse - java inheritance -  ENTITY IfcRelAssignsToProcess
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcEventTypeEnum
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected int a10; // EventTriggerType - current entity - ENUMERATION IfcEventTriggerTypeEnum
	protected static final jsdai.dictionary.CExplicit_attribute a10$ = CEntity.initExplicitAttribute(definition, 10);
	protected String a11; // UserDefinedEventTriggerType - current entity - STRING
...
*/
	...
	// protected String a7;
	// ProcessType - explicit - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4215=EXPLICIT_ATTRIBUTE('PredefinedType',#4213,0,#2863,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfceventtype type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #4216=EXPLICIT_ATTRIBUTE('EventTriggerType',#4213,1,#2861,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeEventtriggertype(EIfceventtype type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #4217=EXPLICIT_ATTRIBUTE('UserDefinedEventTriggerType',#4213,2,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeUserdefinedeventtriggertype(EIfceventtype type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a9 = av.entityValues[0].getEnumeration(0, a9$);
		a10 = av.entityValues[0].getEnumeration(1, a10$);
		a11 = av.entityValues[0].getString(2);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcEventType
		av.entityValues[0].setEnumeration(0, a9, a9$);
		av.entityValues[0].setEnumeration(1, a10, a10$);
		av.entityValues[0].setString(2, a11);
...
*/
	...
	public int rIfceventtypeCorrecteventtriggertype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcEventTriggerTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcEventTriggerTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcEventTriggerTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcEventTriggerTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLabel).set(_context, get(a11$)))))).getLogical());
	}
	public int rIfceventtypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcEventTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcEventTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcEventTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcEventTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfceventtype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfctypeprocess.class).getAttribute(jsdai.SIfc4.CIfctypeprocess.attributeProcesstype(null), _context))))).getLogical());
	}
}
