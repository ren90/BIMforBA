...
// Java class implementing entity IfcRelAssignsToGroup

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcrelassignstogroup extends CIfcrelassigns implements EIfcrelassignstogroup {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcrelassignstogroup.class, SIfc4.ss);
...
/*
	...
	protected Object a6; // RelatingGroup - current entity - ENTITY IfcGroup
...
*/
	...
	// protected int a5;
	// RelatingGroup - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	protected Object a6;
...
*/
	...
	// attribute (current explicit or supertype explicit) : RelatingGroup, base type: entity IfcGroup
	...
	public EIfcgroup getRelatinggroup(EIfcrelassignstogroup type) throws SdaiException {
		return (EIfcgroup)get_instance(a6);
	}
	...
	public static jsdai.dictionary.EAttribute attributeRelatinggroup(EIfcrelassignstogroup type) throws SdaiException {
		return a6$;
	}
...
*/
	...
	public int rIfcrelassignstogroupNoselfreference(SdaiContext _context) throws SdaiException {
									...
									Value _internal_aggregate_source214 = Value.alloc(jsdai.SIfc4.CIfcrelassignstogroup.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcrelassigns.class).getAttribute(jsdai.SIfc4.CIfcrelassigns.attributeRelatedobjects(null), _context);
									Value _result212 = Value.alloc(_internal_aggregate_source214).create();
									if (_internal_aggregate_source214.getActualJavaType() != Value.INDETERMINATE) {
										for (int _i213 = 1; _i213 <= _internal_aggregate_source214.getMemberCount(); _i213++) {
											Value _implicit_50_Temp = _internal_aggregate_source214.getByIndex(_i213);
											if (Value.alloc(ExpressTypes.LOGICAL_TYPE).instanceEqual(_context, Value.alloc(jsdai.SIfc4.CIfcgroup.definition).set(_context, get(a6$)), _implicit_50_Temp).getLogical() == 2) {
												_result212.addMember(_context, _implicit_50_Temp);
											} else
											if (_internal_aggregate_source214.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
												_implicit_50_Temp.unset();
												_result212.addMember(_context, _implicit_50_Temp);
											}
										}
									} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt0(_context, _result212), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0))).getLogical());
	}
}
