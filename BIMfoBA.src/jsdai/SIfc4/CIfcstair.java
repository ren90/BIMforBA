...
// Java class implementing entity IfcStair

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcstair extends CIfcbuildingelement implements EIfcstair {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcstair.class, SIfc4.ss);
...
/*
	...
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcStairTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5779=EXPLICIT_ATTRIBUTE('PredefinedType',#5777,0,#3031,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcstair type) throws SdaiException {
		return a8$;
	}
...
*/
	...
	public int rIfcstairCorrectshapedecomposition(SdaiContext _context) throws SdaiException {
																	...
																	Value _internal_aggregate_source280 = Value.alloc(jsdai.SIfc4.CIfcstair.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcproduct.class).getAttribute(jsdai.SIfc4.CIfcproduct.attributeRepresentation(null), _context).getAttribute(jsdai.SIfc4.CIfcproductrepresentation.attributeRepresentations(null), _context);
																	Value _result278 = Value.alloc(_internal_aggregate_source280).create();
																	if (_internal_aggregate_source280.getActualJavaType() != Value.INDETERMINATE) {
																		for (int _i279 = 1; _i279 <= _internal_aggregate_source280.getMemberCount(); _i279++) {
																			Value _implicit_66_temp = _internal_aggregate_source280.getByIndex(_i279);
																			if (Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, _implicit_66_temp.getAttribute("RepresentationIdentifier", _context), Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "Body")).getLogical() == 2) {
																				_result278.addMember(_context, _implicit_66_temp);
																			} else
																			if (_internal_aggregate_source280.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
																				_implicit_66_temp.unset();
																				_result278.addMember(_context, _implicit_66_temp);
																			}
																		}
																	} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).hiIndex(Value.alloc(jsdai.SIfc4.CIfcstair.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeIsdecomposedby(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).hiIndex(Value.alloc(jsdai.SIfc4.CIfcstair.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeIsdecomposedby(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1)), Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcstair.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcproduct.class).getAttribute(jsdai.SIfc4.CIfcproduct.attributeRepresentation(null), _context))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcstair.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcproduct.class).getAttribute(jsdai.SIfc4.CIfcproduct.attributeRepresentation(null), _context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(_result278), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0))))))).getLogical());
	}
	public int rIfcstairCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSTAIRTYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcstair.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
	public int rIfcstairCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStairTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStairTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStairTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStairTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStairTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcstair.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
