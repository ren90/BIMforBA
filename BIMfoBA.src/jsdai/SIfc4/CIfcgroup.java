...
// Java class implementing entity IfcGroup

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcgroup extends CIfcobject implements EIfcgroup {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcgroup.class, SIfc4.ss);
...
/*
	...
	// IsGroupedBy: protected Object  - inverse - current -  ENTITY IfcRelAssignsToGroup
...
*/
	...
	// IsGroupedBy - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i11$ = CEntity.initInverseAttribute(definition, 11);
...
*/
	...
	public AIfcrelassignstogroup getIsgroupedby(EIfcgroup type, ASdaiModel domain) throws SdaiException {
		AIfcrelassignstogroup result = (AIfcrelassignstogroup)get_inverse_aggregate(i11$);
		CIfcrelassignstogroup.usedinRelatinggroup(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeIsgroupedby(EIfcgroup type) throws SdaiException {
		return i11$;
	}
