...
// Java class implementing EXPRESS function IfcVectorDifference
...
public class FIfcvectordifference {
		...
		if (true) return Value.alloc(jsdai.SIfc4.CIfcvector.definition).set(_context, Value.alloc(ExpressTypes.GENERIC_TYPE).unset()).check(_context, jsdai.SIfc4.CIfcvector.definition);
																																															...
																																															{ // BEGIN
																																																...
																																																_e_Mag.set(_context, Value.alloc(ExpressTypes.REAL_TYPE).set(_context, 0.0));
																																																				Value _elements590 = Value.alloc(ExpressTypes.AGGREGATE_GENERIC_TYPE).create();
																																																				for (int _index590_0 = 0; _index590_0 < _e_Ndim.getInteger(); _index590_0++)
																																																					_elements590.addMember(_context, Value.alloc(ExpressTypes.REAL_TYPE).set(_context, 0.0));
																																																_e_Res.set(_context, new jsdai.lang.Value(CIfcrepresentationitem.definition).addComplex(new jsdai.lang.Value(CIfcgeometricrepresentationitem.definition)).addComplex(new jsdai.lang.Value(CIfcdirection.definition).addParameter(_elements590)));
																																																Value _end591 = Value.alloc(ExpressTypes.NUMBER_TYPE).set(_e_Ndim);
																																																Value _step591 = Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1);
																																																for (Value _implicit_150_i=Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1);Value.alloc(ExpressTypes.LOGICAL_TYPE).lequal(_context, _implicit_150_i, _end591).getLogical() == 2;_implicit_150_i.inc(_step591)) {																																																
																																																	_e_Res.getAttribute(jsdai.SIfc4.CIfcdirection.attributeDirectionratios(null), _context).indexing(_implicit_150_i, null).set(_context, Value.alloc().substractOrDifference(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).mulOrIntersect(_context, _e_Mag1, _e_Vec1.getAttribute(jsdai.SIfc4.CIfcdirection.attributeDirectionratios(null), _context).indexing(_implicit_150_i, null)), Value.alloc(ExpressTypes.INTEGER_TYPE).mulOrIntersect(_context, _e_Mag2, _e_Vec2.getAttribute(jsdai.SIfc4.CIfcdirection.attributeDirectionratios(null), _context).indexing(_implicit_150_i, null))));																																																
																																																	_e_Mag.set(_context, Value.alloc().addOrUnionOrConcatenate(_context, _e_Mag, Value.alloc(ExpressTypes.INTEGER_TYPE).mulOrIntersect(_context, _e_Res.getAttribute(jsdai.SIfc4.CIfcdirection.attributeDirectionratios(null), _context).indexing(_implicit_150_i, null), _e_Res.getAttribute(jsdai.SIfc4.CIfcdirection.attributeDirectionratios(null), _context).indexing(_implicit_150_i, null))));
																																																} // for - REPEAT
