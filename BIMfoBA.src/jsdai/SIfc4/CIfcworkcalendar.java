...
// Java class implementing entity IfcWorkCalendar

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcworkcalendar extends CIfccontrol implements EIfcworkcalendar {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcworkcalendar.class, SIfc4.ss);
...
/*
	...
	protected AIfcworktime a6; // WorkingTimes - current entity - SET OF ENTITY
	protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	protected AIfcworktime a7; // ExceptionTimes - current entity - SET OF ENTITY
	protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcWorkCalendarTypeEnum
...
*/
	...
	// WorkingTimes - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	protected AIfcworktime a6;
	// ExceptionTimes - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	protected AIfcworktime a7;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6410=EXPLICIT_ATTRIBUTE('WorkingTimes',#6408,0,#7205,$,.T.);
	//<01> generating methods for consolidated attribute:  WorkingTimes
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// methods for attribute: WorkingTimes, base type: SET OF ENTITY
	public static int usedinWorkingtimes(EIfcworkcalendar type, EIfcworktime instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public AIfcworktime getWorkingtimes(EIfcworkcalendar type) throws SdaiException {
		return (AIfcworktime)get_aggregate(a6);
	}
	public AIfcworktime createWorkingtimes(EIfcworkcalendar type) throws SdaiException {
		a6 = (AIfcworktime)create_aggregate_class(a6, a6$,  AIfcworktime.class, 0);
		return a6;
	}
	...
	public static jsdai.dictionary.EAttribute attributeWorkingtimes(EIfcworkcalendar type) throws SdaiException {
		return a6$;
	}

	//going through all the attributes: #6411=EXPLICIT_ATTRIBUTE('ExceptionTimes',#6408,1,#7206,$,.T.);
	//<01> generating methods for consolidated attribute:  ExceptionTimes
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// methods for attribute: ExceptionTimes, base type: SET OF ENTITY
	public static int usedinExceptiontimes(EIfcworkcalendar type, EIfcworktime instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public AIfcworktime getExceptiontimes(EIfcworkcalendar type) throws SdaiException {
		return (AIfcworktime)get_aggregate(a7);
	}
	public AIfcworktime createExceptiontimes(EIfcworkcalendar type) throws SdaiException {
		a7 = (AIfcworktime)create_aggregate_class(a7, a7$,  AIfcworktime.class, 0);
		return a7;
	}
	...
	public static jsdai.dictionary.EAttribute attributeExceptiontimes(EIfcworkcalendar type) throws SdaiException {
		return a7$;
	}

	//going through all the attributes: #6412=EXPLICIT_ATTRIBUTE('PredefinedType',#6408,2,#3105,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcworkcalendar type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a6 = (AIfcworktime)av.entityValues[4].getInstanceAggregate(0, a6$, this);
		a7 = (AIfcworktime)av.entityValues[4].getInstanceAggregate(1, a7$, this);
		a8 = av.entityValues[4].getEnumeration(2, a8$);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcWorkCalendar
		av.entityValues[4].setInstanceAggregate(0, a6);
		av.entityValues[4].setInstanceAggregate(1, a7);
		av.entityValues[4].setEnumeration(2, a8, a8$);
	}
*/
	...
	public int rIfcworkcalendarCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkCalendarTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkCalendarTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkCalendarTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkCalendarTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkCalendarTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcworkcalendar.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
