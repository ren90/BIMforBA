...
// Java class implementing entity IfcSubContractResourceType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcsubcontractresourcetype extends CIfcconstructionresourcetype implements EIfcsubcontractresourcetype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcsubcontractresourcetype.class, SIfc4.ss);
...
/*
	...
	protected int a11; // PredefinedType - current entity - ENUMERATION IfcSubContractResourceTypeEnum
...
*/
	...
	//going through all the attributes: #5948=EXPLICIT_ATTRIBUTE('PredefinedType',#5946,0,#3043,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcsubcontractresourcetype type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a11 = av.entityValues[3].getEnumeration(0, a11$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcSubContractResourceType
		av.entityValues[3].setEnumeration(0, a11, a11$);
...
*/
	...
	public int rIfcsubcontractresourcetypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSubContractResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSubContractResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSubContractResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSubContractResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcsubcontractresourcetype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfctyperesource.class).getAttribute(jsdai.SIfc4.CIfctyperesource.attributeResourcetype(null), _context))))).getLogical());
	}
}
