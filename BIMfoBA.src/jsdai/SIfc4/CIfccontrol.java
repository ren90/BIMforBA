...
// Java class implementing entity IfcControl

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfccontrol extends CIfcobject implements EIfccontrol {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfccontrol.class, SIfc4.ss);
...
/*
	...
	// Controls: protected Object  - inverse - current -  ENTITY IfcRelAssignsToControl
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a5$ = CEntity.initExplicitAttribute(definition, 5);
	protected String a5;
	// Controls - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i11$ = CEntity.initInverseAttribute(definition, 11);
...
*/
	...
	public static jsdai.dictionary.EAttribute attributeIdentification(EIfccontrol type) throws SdaiException {
		return a5$;
	}
	...
	public AIfcrelassignstocontrol getControls(EIfccontrol type, ASdaiModel domain) throws SdaiException {
		AIfcrelassignstocontrol result = (AIfcrelassignstocontrol)get_inverse_aggregate(i11$);
		CIfcrelassignstocontrol.usedinRelatingcontrol(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeControls(EIfccontrol type) throws SdaiException {
		return i11$;
	}
