...
// Java class implementing entity IfcStairFlight

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcstairflight extends CIfcbuildingelement implements EIfcstairflight {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcstairflight.class, SIfc4.ss);
...
*/
	...
	// NumberOfRiser - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected int a8;
	// NumberOfTreads - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected int a9;
	// RiserHeight - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a10$ = CEntity.initExplicitAttribute(definition, 10);
	protected double a10;
	// TreadLength - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a11$ = CEntity.initExplicitAttribute(definition, 11);
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5782=EXPLICIT_ATTRIBUTE('NumberOfRiser',#5780,0,#2,$,.T.);
	//<01> generating methods for consolidated attribute:  NumberOfRiser
	//<01-0> current entity
	...
	public boolean testNumberofriser(EIfcstairflight type) throws SdaiException {
		return test_integer(a8);
	}
	public int getNumberofriser(EIfcstairflight type) throws SdaiException {
		return get_integer(a8);
	}
	public void setNumberofriser(EIfcstairflight type, int value) throws SdaiException {
		a8 = set_integer(value);
	}
	public void unsetNumberofriser(EIfcstairflight type) throws SdaiException {
		a8 = unset_integer();
	}
	public static jsdai.dictionary.EAttribute attributeNumberofriser(EIfcstairflight type) throws SdaiException {
		return a8$;
	}

	//going through all the attributes: #5783=EXPLICIT_ATTRIBUTE('NumberOfTreads',#5780,1,#2,$,.T.);
	//<01> generating methods for consolidated attribute:  NumberOfTreads
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public boolean testNumberoftreads(EIfcstairflight type) throws SdaiException {
		return test_integer(a9);
	}
	public int getNumberoftreads(EIfcstairflight type) throws SdaiException {
		return get_integer(a9);
	}
	public void setNumberoftreads(EIfcstairflight type, int value) throws SdaiException {
		a9 = set_integer(value);
	}
	public void unsetNumberoftreads(EIfcstairflight type) throws SdaiException {
		a9 = unset_integer();
	}
	public static jsdai.dictionary.EAttribute attributeNumberoftreads(EIfcstairflight type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #5784=EXPLICIT_ATTRIBUTE('RiserHeight',#5780,2,#2605,$,.T.);
	//<01> generating methods for consolidated attribute:  RiserHeight
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeRiserheight(EIfcstairflight type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #5785=EXPLICIT_ATTRIBUTE('TreadLength',#5780,3,#2605,$,.T.);
	//<01> generating methods for consolidated attribute:  TreadLength
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeTreadlength(EIfcstairflight type) throws SdaiException {
		return a11$;
	}

	//going through all the attributes: #5786=EXPLICIT_ATTRIBUTE('PredefinedType',#5780,4,#3029,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcstairflight type) throws SdaiException {
		return a12$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a8 = av.entityValues[6].getInteger(0);
		a9 = av.entityValues[6].getInteger(1);
		a10 = av.entityValues[6].getDouble(2);
		a11 = av.entityValues[6].getDouble(3);
		a12 = av.entityValues[6].getEnumeration(4, a12$);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcStairFlight
		av.entityValues[6].setInteger(0, a8);
		av.entityValues[6].setInteger(1, a9);
		av.entityValues[6].setDouble(2, a10);
		av.entityValues[6].setDouble(3, a11);
		av.entityValues[6].setEnumeration(4, a12, a12$);
	}
*/
	...
	public int rIfcstairflightCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSTAIRFLIGHTTYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcstairflight.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
	public int rIfcstairflightCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStairFlightTypeEnum).set(_context, get(a12$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStairFlightTypeEnum).set(_context, get(a12$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStairFlightTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStairFlightTypeEnum).set(_context, get(a12$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStairFlightTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcstairflight.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
