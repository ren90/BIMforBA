...
// Java class implementing entity IfcStructuralLoadCase

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcstructuralloadcase extends CIfcstructuralloadgroup implements EIfcstructuralloadcase {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcstructuralloadcase.class, SIfc4.ss);
...
/*
	...
	// PredefinedType: protected int a5;   PredefinedType - java inheritance - ENUMERATION IfcLoadGroupTypeEnum
	// ActionType: protected int a6;   ActionType - java inheritance - ENUMERATION IfcActionTypeEnum
	// ActionSource: protected int a7;   ActionSource - java inheritance - ENUMERATION IfcActionSourceTypeEnum
	// Coefficient: protected double a8;   Coefficient - java inheritance - REAL
	// Purpose: protected String a9;   Purpose - java inheritance - STRING
	// SourceOfResultGroup: protected Object  - inverse - java inheritance -  ENTITY IfcStructuralResultGroup
	// LoadGroupFor: protected Object  - inverse - java inheritance -  ENTITY IfcStructuralAnalysisModel
	protected A_double a10; // SelfWeightCoefficients - current entity - LIST OF REAL
...
*/
	...
	// protected int a5;
	// ActionType - explicit - java inheritance
	// protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	// protected int a6;
	// ActionSource - explicit - java inheritance
	// protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	// protected int a7;
	// Coefficient - explicit - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5841=EXPLICIT_ATTRIBUTE('SelfWeightCoefficients',#5839,0,#7141,$,.T.);
	//<01> generating methods for consolidated attribute:  SelfWeightCoefficients
	//<01-0> current entity
	...
	public static jsdai.dictionary.EAttribute attributeSelfweightcoefficients(EIfcstructuralloadcase type) throws SdaiException {
		return a10$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a10 = av.entityValues[4].getDoubleAggregate(0, a10$, this);
		a5 = av.entityValues[5].getEnumeration(0, a5$);
		a6 = av.entityValues[5].getEnumeration(1, a6$);
		a7 = av.entityValues[5].getEnumeration(2, a7$);
		a8 = av.entityValues[5].getDouble(3);
		a9 = av.entityValues[5].getString(4);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcStructuralLoadCase
		av.entityValues[4].setDoubleAggregate(0, a10);
		// partial entity: IfcStructuralLoadGroup
		av.entityValues[5].setEnumeration(0, a5, a5$);
		av.entityValues[5].setEnumeration(1, a6, a6$);
		av.entityValues[5].setEnumeration(2, a7, a7$);
		av.entityValues[5].setDouble(3, a8);
		av.entityValues[5].setString(4, a9);
	}
*/
	...
	public int rIfcstructuralloadcaseIsloadcasepredefinedtype(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.CIfcstructuralloadcase.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcstructuralloadgroup.class).getAttribute(jsdai.SIfc4.CIfcstructuralloadgroup.attributePredefinedtype(null), _context), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLoadGroupTypeEnum).setEnum(_context, "LOAD_CASE"))).getLogical());
	}
}
