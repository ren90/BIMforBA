...
// Java class implementing entity IfcSpatialZoneType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcspatialzonetype extends CIfcspatialelementtype implements EIfcspatialzonetype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcspatialzonetype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcSpatialZoneTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5766=EXPLICIT_ATTRIBUTE('PredefinedType',#5764,0,#3025,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcspatialzonetype type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #5767=EXPLICIT_ATTRIBUTE('LongName',#5764,1,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeLongname(EIfcspatialzonetype type) throws SdaiException {
		return a10$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a10 = av.entityValues[3].getString(1);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcSpatialZoneType
		av.entityValues[3].setEnumeration(0, a9, a9$);
		av.entityValues[3].setString(1, a10);
...
*/
	...
	public int rIfcspatialzonetypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpatialZoneTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpatialZoneTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpatialZoneTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpatialZoneTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcspatialzonetype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcspatialelementtype.class).getAttribute(jsdai.SIfc4.CIfcspatialelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
