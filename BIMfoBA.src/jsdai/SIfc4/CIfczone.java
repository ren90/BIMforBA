...
// Java class implementing entity IfcZone

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfczone extends CIfcsystem implements EIfczone {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfczone.class, SIfc4.ss);
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6443=EXPLICIT_ATTRIBUTE('LongName',#6441,0,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeLongname(EIfczone type) throws SdaiException {
		return a5$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a5 = av.entityValues[5].getString(0);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcZone
		av.entityValues[5].setString(0, a5);
	}
*/
	...
	public int rIfczoneWr1(SdaiContext _context) throws SdaiException {
											...
											Value _internal_aggregate_source338 = Value.alloc(jsdai.SIfc4.CIfczone.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcgroup.class).getAttribute(jsdai.SIfc4.CIfcgroup.attributeIsgroupedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatedObjects", _context);
											Value _result336 = Value.alloc(_internal_aggregate_source338).create();
											if (_internal_aggregate_source338.getActualJavaType() != Value.INDETERMINATE) {
												for (int _i337 = 1; _i337 <= _internal_aggregate_source338.getMemberCount(); _i337++) {
													Value _implicit_79_temp = _internal_aggregate_source338.getByIndex(_i337);
													if (Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCZONE", "IFC4"), _implicit_79_temp.typeOfV(_context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSPACE", "IFC4"), _implicit_79_temp.typeOfV(_context))), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSPATIALZONE", "IFC4"), _implicit_79_temp.typeOfV(_context)))).getLogical() == 2) {
														_result336.addMember(_context, _implicit_79_temp);
													} else
													if (_internal_aggregate_source338.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
														_implicit_79_temp.unset();
														_result336.addMember(_context, _implicit_79_temp);
													}
												}
											} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(jsdai.SIfc4.CIfczone.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcgroup.class).getAttribute(jsdai.SIfc4.CIfcgroup.attributeIsgroupedby(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(_result336), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)))).getLogical());
	}
}
