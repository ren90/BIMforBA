...
// Java class implementing entity IfcInventory

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcinventory extends CIfcgroup implements EIfcinventory {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcinventory.class, SIfc4.ss);
...
/*
	...
	protected int a5; // PredefinedType - current entity - ENUMERATION IfcInventoryTypeEnum
	protected static final jsdai.dictionary.CExplicit_attribute a5$ = CEntity.initExplicitAttribute(definition, 5);
	protected Object a6; // Jurisdiction - current entity - SELECT IfcActorSelect
	protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	protected AIfcperson a7; // ResponsiblePersons - current entity - SET OF ENTITY
	protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	protected String a8; // LastUpdateDate - current entity - STRING
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected Object a9; // CurrentValue - current entity - ENTITY IfcCostValue
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected Object a10; // OriginalValue - current entity - ENTITY IfcCostValue
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a5$ = CEntity.initExplicitAttribute(definition, 5);
	protected int a5;
	// Jurisdiction - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	protected Object a6;
	// ResponsiblePersons - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	protected AIfcperson a7;
	// LastUpdateDate - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected String a8;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4500=EXPLICIT_ATTRIBUTE('PredefinedType',#4498,0,#2901,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcinventory type) throws SdaiException {
		return a5$;
	}

	//going through all the attributes: #4501=EXPLICIT_ATTRIBUTE('Jurisdiction',#4498,1,#3111,$,.T.);
	//<01> generating methods for consolidated attribute:  Jurisdiction
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// -2- methods for SELECT attribute: Jurisdiction
	public static int usedinJurisdiction(EIfcinventory type, EEntity instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a6$, domain, result);
	}
	public boolean testJurisdiction(EIfcinventory type) throws SdaiException {
		return test_instance(a6);
	}

	public EEntity getJurisdiction(EIfcinventory type) throws SdaiException { // case 1
		return get_instance_select(a6);
	}

	public void setJurisdiction(EIfcinventory type, EEntity value) throws SdaiException { // case 1
		a6 = set_instance(a6, value);
	}

	public void unsetJurisdiction(EIfcinventory type) throws SdaiException {
		a6 = unset_instance(a6);
	}

	public static jsdai.dictionary.EAttribute attributeJurisdiction(EIfcinventory type) throws SdaiException {
		return a6$;
	}

	//going through all the attributes: #4502=EXPLICIT_ATTRIBUTE('ResponsiblePersons',#4498,2,#6945,$,.T.);
	//<01> generating methods for consolidated attribute:  ResponsiblePersons
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// methods for attribute: ResponsiblePersons, base type: SET OF ENTITY
	public static int usedinResponsiblepersons(EIfcinventory type, EIfcperson instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static jsdai.dictionary.EAttribute attributeResponsiblepersons(EIfcinventory type) throws SdaiException {
		return a7$;
	}

	//going through all the attributes: #4503=EXPLICIT_ATTRIBUTE('LastUpdateDate',#4498,3,#2475,$,.T.);
	//<01> generating methods for consolidated attribute:  LastUpdateDate
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeLastupdatedate(EIfcinventory type) throws SdaiException {
		return a8$;
	}

	//going through all the attributes: #4504=EXPLICIT_ATTRIBUTE('CurrentValue',#4498,4,#3847,$,.T.);
	...
	public static int usedinCurrentvalue(EIfcinventory type, EIfccostvalue instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public EIfccostvalue getCurrentvalue(EIfcinventory type) throws SdaiException {
		return (EIfccostvalue)get_instance(a9);
	}
	...
	public static jsdai.dictionary.EAttribute attributeCurrentvalue(EIfcinventory type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #4505=EXPLICIT_ATTRIBUTE('OriginalValue',#4498,5,#3847,$,.T.);
	...
	public static int usedinOriginalvalue(EIfcinventory type, EIfccostvalue instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public EIfccostvalue getOriginalvalue(EIfcinventory type) throws SdaiException {
		return (EIfccostvalue)get_instance(a10);
	}
	...
	public static jsdai.dictionary.EAttribute attributeOriginalvalue(EIfcinventory type) throws SdaiException {
		return a10$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a5 = av.entityValues[1].getEnumeration(0, a5$);
		a6 = av.entityValues[1].getInstance(1, this, a6$);
		a7 = (AIfcperson)av.entityValues[1].getInstanceAggregate(2, a7$, this);
		a8 = av.entityValues[1].getString(3);
		a9 = av.entityValues[1].getInstance(4, this, a9$);
		a10 = av.entityValues[1].getInstance(5, this, a10$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcInventory
		av.entityValues[1].setEnumeration(0, a5, a5$);
		av.entityValues[1].setInstance(1, a6);
		av.entityValues[1].setInstanceAggregate(2, a7);
		av.entityValues[1].setString(3, a8);
		av.entityValues[1].setInstance(4, a9);
		av.entityValues[1].setInstance(5, a10);
