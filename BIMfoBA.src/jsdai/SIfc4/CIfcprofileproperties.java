...
// Java class implementing entity IfcProfileProperties

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcprofileproperties extends CIfcextendedproperties implements EIfcprofileproperties {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcprofileproperties.class, SIfc4.ss);
...
/*
	...
	protected Object a3; // ProfileDefinition - current entity - ENTITY IfcProfileDef
...
*/
	...
	// ProfileDefinition - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a3$ = CEntity.initExplicitAttribute(definition, 3);
	protected Object a3;
...
*/
	...
	//going through all the attributes: #5076=EXPLICIT_ATTRIBUTE('ProfileDefinition',#5074,0,#5068,$,.F.);
	//<01> generating methods for consolidated attribute:  ProfileDefinition
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// attribute (current explicit or supertype explicit) : ProfileDefinition, base type: entity IfcProfileDef
	public static int usedinProfiledefinition(EIfcprofileproperties type, EIfcprofiledef instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static jsdai.dictionary.EAttribute attributeProfiledefinition(EIfcprofileproperties type) throws SdaiException {
		return a3$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcProfileProperties
