...
// Java class implementing entity IfcAnnotation

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcannotation extends CIfcproduct implements EIfcannotation {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcannotation.class, SIfc4.ss);
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3290=INVERSE_ATTRIBUTE('ContainedInStructure',#3288,0,#5438,$,#5440,#7579,#7580,.F.);
	...
	public AIfcrelcontainedinspatialstructure getContainedinstructure(EIfcannotation type, ASdaiModel domain) throws SdaiException {
	...
	public static jsdai.dictionary.EAttribute attributeContainedinstructure(EIfcannotation type) throws SdaiException {
		return i12$;
	}
