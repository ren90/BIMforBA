...
// Java class implementing entity IfcStructuralLinearAction

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcstructurallinearaction extends CIfcstructuralcurveaction implements EIfcstructurallinearaction {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcstructurallinearaction.class, SIfc4.ss);
...
/*
	...
	// ProjectedOrTrue: protected int a10;   ProjectedOrTrue - java inheritance - ENUMERATION IfcProjectedOrTrueLengthEnum
	// PredefinedType: protected int a11;   PredefinedType - java inheritance - ENUMERATION IfcStructuralCurveActivityTypeEnum
*/
	...
	// protected int a9;
	// ProjectedOrTrue - explicit - java inheritance
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcStructuralLinearAction
	}
*/
	...
	public int rIfcstructurallinearactionConstpredefinedtype(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.CIfcstructurallinearaction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcstructuralcurveaction.class).getAttribute(jsdai.SIfc4.CIfcstructuralcurveaction.attributePredefinedtype(null), _context), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).setEnum(_context, "CONST"))).getLogical());
	}
	public int rIfcstructurallinearactionSuitableloadtype(SdaiContext _context) throws SdaiException {
	



									Value _elements281 = Value.alloc(ExpressTypes.AGGREGATE_GENERIC_TYPE).create();
									_elements281.addMember(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSTRUCTURALLOADLINEARFORCE", "IFC4"));
									_elements281.addMember(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSTRUCTURALLOADTEMPERATURE", "IFC4"));
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt(_context, Value.alloc().mulOrIntersect(_context, _elements281, Value.alloc(jsdai.SIfc4.CIfcstructurallinearaction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcstructuralactivity.class).getAttribute(jsdai.SIfc4.CIfcstructuralactivity.attributeAppliedload(null), _context).typeOfV(_context))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1))).getLogical());
	}
}
