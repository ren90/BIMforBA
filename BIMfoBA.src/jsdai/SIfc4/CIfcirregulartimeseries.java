...
// Java class implementing entity IfcIrregularTimeSeries

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcirregulartimeseries extends CIfctimeseries implements EIfcirregulartimeseries {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcirregulartimeseries.class, SIfc4.ss);
...
/*
	...
	protected AIfcirregulartimeseriesvalue a8; // Values - current entity - LIST OF ENTITY
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected AIfcirregulartimeseriesvalue a8;
...
*/
	...
	//going through all the attributes: #4508=EXPLICIT_ATTRIBUTE('Values',#4506,0,#6946,$,.F.);
	//<01> generating methods for consolidated attribute:  Values
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// methods for attribute: Values, base type: LIST OF ENTITY
	public static int usedinValues(EIfcirregulartimeseries type, EIfcirregulartimeseriesvalue instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public AIfcirregulartimeseriesvalue getValues(EIfcirregulartimeseries type) throws SdaiException {
		return (AIfcirregulartimeseriesvalue)get_aggregate(a8);
	}
	public AIfcirregulartimeseriesvalue createValues(EIfcirregulartimeseries type) throws SdaiException {
		a8 = (AIfcirregulartimeseriesvalue)create_aggregate_class(a8, a8$,  AIfcirregulartimeseriesvalue.class, 0);
		return a8;
	}
	...
	public static jsdai.dictionary.EAttribute attributeValues(EIfcirregulartimeseries type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a8 = (AIfcirregulartimeseriesvalue)av.entityValues[0].getInstanceAggregate(0, a8$, this);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcIrregularTimeSeries
		av.entityValues[0].setInstanceAggregate(0, a8);
