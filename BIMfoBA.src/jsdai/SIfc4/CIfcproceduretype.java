...
// Java class implementing entity IfcProcedureType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcproceduretype extends CIfctypeprocess implements EIfcproceduretype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcproceduretype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcProcedureTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5046=EXPLICIT_ATTRIBUTE('PredefinedType',#5044,0,#2961,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcproceduretype type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcProcedureType
...
*/
	...
	public int rIfcproceduretypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProcedureTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProcedureTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProcedureTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProcedureTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcproceduretype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfctypeprocess.class).getAttribute(jsdai.SIfc4.CIfctypeprocess.attributeProcesstype(null), _context))))).getLogical());
	}
}
