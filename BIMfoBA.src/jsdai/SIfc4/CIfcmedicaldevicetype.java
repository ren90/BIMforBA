...
// Java class implementing entity IfcMedicalDeviceType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcmedicaldevicetype extends CIfcflowterminaltype implements EIfcmedicaldevicetype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcmedicaldevicetype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcMedicalDeviceTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4751=EXPLICIT_ATTRIBUTE('PredefinedType',#4749,0,#2925,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcmedicaldevicetype type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcMedicalDeviceType
...
*/
	...
	public int rIfcmedicaldevicetypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
