...
// Java class implementing entity IfcStructuralPlanarAction

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcstructuralplanaraction extends CIfcstructuralsurfaceaction implements EIfcstructuralplanaraction {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcstructuralplanaraction.class, SIfc4.ss);
...
/*
	...
	// PredefinedType: protected int a11;   PredefinedType - java inheritance - ENUMERATION IfcStructuralSurfaceActivityTypeEnum
*/
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a10 = av.entityValues[7].getEnumeration(0, a10$);
		a11 = av.entityValues[7].getEnumeration(1, a11$);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcStructuralPlanarAction
		// partial entity: IfcStructuralSurfaceAction
		av.entityValues[7].setEnumeration(0, a10, a10$);
		av.entityValues[7].setEnumeration(1, a11, a11$);
	}
*/
	...
	public int rIfcstructuralplanaractionConstpredefinedtype(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.CIfcstructuralplanaraction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcstructuralsurfaceaction.class).getAttribute(jsdai.SIfc4.CIfcstructuralsurfaceaction.attributePredefinedtype(null), _context), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralSurfaceActivityTypeEnum).setEnum(_context, "CONST"))).getLogical());
	}
	public int rIfcstructuralplanaractionSuitableloadtype(SdaiContext _context) throws SdaiException {
	



									Value _elements282 = Value.alloc(ExpressTypes.AGGREGATE_GENERIC_TYPE).create();
									_elements282.addMember(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSTRUCTURALLOADPLANARFORCE", "IFC4"));
									_elements282.addMember(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSTRUCTURALLOADTEMPERATURE", "IFC4"));
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt(_context, Value.alloc().mulOrIntersect(_context, _elements282, Value.alloc(jsdai.SIfc4.CIfcstructuralplanaraction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcstructuralactivity.class).getAttribute(jsdai.SIfc4.CIfcstructuralactivity.attributeAppliedload(null), _context).typeOfV(_context))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1))).getLogical());
	}
}
