...
// Java class implementing entity IfcAirToAirHeatRecoveryType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcairtoairheatrecoverytype extends CIfcenergyconversiondevicetype implements EIfcairtoairheatrecoverytype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcairtoairheatrecoverytype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcAirToAirHeatRecoveryTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3281=EXPLICIT_ATTRIBUTE('PredefinedType',#3279,0,#2713,$,.F.);
	...
	public boolean testPredefinedtype(EIfcairtoairheatrecoverytype type) throws SdaiException {
		return test_enumeration(a9);
	}
	public int getPredefinedtype(EIfcairtoairheatrecoverytype type) throws SdaiException {
		return get_enumeration(a9);
	}
	public void setPredefinedtype(EIfcairtoairheatrecoverytype type, int value) throws SdaiException {
		a9 = set_enumeration(value, a9$);
	}
	public void unsetPredefinedtype(EIfcairtoairheatrecoverytype type) throws SdaiException {
		a9 = unset_enumeration();
	}
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcairtoairheatrecoverytype type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcAirToAirHeatRecoveryType
		...
		// partial entity: IfcEnergyConversionDeviceType
...
*/
	...
	public int rIfcairtoairheatrecoverytypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcAirToAirHeatRecoveryTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcAirToAirHeatRecoveryTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcAirToAirHeatRecoveryTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcAirToAirHeatRecoveryTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcairtoairheatrecoverytype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
