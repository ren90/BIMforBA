...
// Java class implementing entity IfcRelAssociatesDocument

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcrelassociatesdocument extends CIfcrelassociates implements EIfcrelassociatesdocument {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcrelassociatesdocument.class, SIfc4.ss);
...
/*
	...
	protected Object a5; // RelatingDocument - current entity - SELECT IfcDocumentSelect
...
*/
	...
	//going through all the attributes: #5390=EXPLICIT_ATTRIBUTE('RelatingDocument',#5388,0,#3145,$,.F.);
	//<01> generating methods for consolidated attribute:  RelatingDocument
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// -2- methods for SELECT attribute: RelatingDocument
	public static int usedinRelatingdocument(EIfcrelassociatesdocument type, EEntity instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a5$, domain, result);
	}
	public boolean testRelatingdocument(EIfcrelassociatesdocument type) throws SdaiException {
		return test_instance(a5);
	}

	public EEntity getRelatingdocument(EIfcrelassociatesdocument type) throws SdaiException { // case 1
		return get_instance_select(a5);
	}

	public void setRelatingdocument(EIfcrelassociatesdocument type, EEntity value) throws SdaiException { // case 1
		a5 = set_instance(a5, value);
	}

	public void unsetRelatingdocument(EIfcrelassociatesdocument type) throws SdaiException {
		a5 = unset_instance(a5);
	}

	public static jsdai.dictionary.EAttribute attributeRelatingdocument(EIfcrelassociatesdocument type) throws SdaiException {
		return a5$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcRelAssociatesDocument
