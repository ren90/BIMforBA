...
// Java class implementing entity IfcSpatialStructureElement

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcspatialstructureelement extends CIfcspatialelement implements EIfcspatialstructureelement {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcspatialstructureelement.class, SIfc4.ss);
...
/*
	...
	protected int a8; // CompositionType - current entity - ENUMERATION IfcElementCompositionEnum
...
*/
	...
	// CompositionType - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected int a8;
...
*/
	...
	public static jsdai.dictionary.EAttribute attributeCompositiontype(EIfcspatialstructureelement type) throws SdaiException {
		return a8$;
	}
...
*/
	...
	public int rIfcspatialstructureelementWr41(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).hiIndex(Value.alloc(jsdai.SIfc4.CIfcspatialstructureelement.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeDecomposes(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELAGGREGATES", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcspatialstructureelement.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeDecomposes(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).typeOfV(_context))), Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCPROJECT", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcspatialstructureelement.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeDecomposes(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingObject", _context).typeOfV(_context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSPATIALSTRUCTUREELEMENT", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcspatialstructureelement.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeDecomposes(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingObject", _context).typeOfV(_context))))).getLogical());
	}
}
