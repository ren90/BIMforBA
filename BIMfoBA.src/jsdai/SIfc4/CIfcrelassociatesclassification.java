...
// Java class implementing entity IfcRelAssociatesClassification

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcrelassociatesclassification extends CIfcrelassociates implements EIfcrelassociatesclassification {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcrelassociatesclassification.class, SIfc4.ss);
...
/*
	...
	protected Object a5; // RelatingClassification - current entity - SELECT IfcClassificationSelect
...
*/
	...
	// RelatingClassification - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a5$ = CEntity.initExplicitAttribute(definition, 5);
	protected Object a5;
...
*/
	...
	//going through all the attributes: #5383=EXPLICIT_ATTRIBUTE('RelatingClassification',#5381,0,#3123,$,.F.);
	//<01> generating methods for consolidated attribute:  RelatingClassification
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// -2- methods for SELECT attribute: RelatingClassification
	public static int usedinRelatingclassification(EIfcrelassociatesclassification type, EEntity instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a5$, domain, result);
	}
	public boolean testRelatingclassification(EIfcrelassociatesclassification type) throws SdaiException {
		return test_instance(a5);
	}

	public EEntity getRelatingclassification(EIfcrelassociatesclassification type) throws SdaiException { // case 1
		return get_instance_select(a5);
	}

	public void setRelatingclassification(EIfcrelassociatesclassification type, EEntity value) throws SdaiException { // case 1
		a5 = set_instance(a5, value);
	}

	public void unsetRelatingclassification(EIfcrelassociatesclassification type) throws SdaiException {
		a5 = unset_instance(a5);
	}

	public static jsdai.dictionary.EAttribute attributeRelatingclassification(EIfcrelassociatesclassification type) throws SdaiException {
		return a5$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcRelAssociatesClassification
