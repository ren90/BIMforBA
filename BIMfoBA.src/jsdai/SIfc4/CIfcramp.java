...
// Java class implementing entity IfcRamp

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcramp extends CIfcbuildingelement implements EIfcramp {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcramp.class, SIfc4.ss);
...
/*
	...
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcRampTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5225=EXPLICIT_ATTRIBUTE('PredefinedType',#5223,0,#2983,$,.T.);
	...
	public boolean testPredefinedtype(EIfcramp type) throws SdaiException {
		return test_enumeration(a8);
	}
	public int getPredefinedtype(EIfcramp type) throws SdaiException {
		return get_enumeration(a8);
	}
	public void setPredefinedtype(EIfcramp type, int value) throws SdaiException {
		a8 = set_enumeration(value, a8$);
	}
	public void unsetPredefinedtype(EIfcramp type) throws SdaiException {
		a8 = unset_enumeration();
	}
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcramp type) throws SdaiException {
		return a8$;
	}
...
*/
	...
	public int rIfcrampCorrectshapedecomposition(SdaiContext _context) throws SdaiException {
																	...
																	Value _internal_aggregate_source198 = Value.alloc(jsdai.SIfc4.CIfcramp.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcproduct.class).getAttribute(jsdai.SIfc4.CIfcproduct.attributeRepresentation(null), _context).getAttribute(jsdai.SIfc4.CIfcproductrepresentation.attributeRepresentations(null), _context);
																	Value _result196 = Value.alloc(_internal_aggregate_source198).create();
																	if (_internal_aggregate_source198.getActualJavaType() != Value.INDETERMINATE) {
																		for (int _i197 = 1; _i197 <= _internal_aggregate_source198.getMemberCount(); _i197++) {
																			Value _implicit_46_temp = _internal_aggregate_source198.getByIndex(_i197);
																			if (Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, _implicit_46_temp.getAttribute("RepresentationIdentifier", _context), Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "Body")).getLogical() == 2) {
																				_result196.addMember(_context, _implicit_46_temp);
																			} else
																			if (_internal_aggregate_source198.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
																				_implicit_46_temp.unset();
																				_result196.addMember(_context, _implicit_46_temp);
																			}
																		}
																	} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).hiIndex(Value.alloc(jsdai.SIfc4.CIfcramp.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeIsdecomposedby(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).hiIndex(Value.alloc(jsdai.SIfc4.CIfcramp.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeIsdecomposedby(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1)), Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcramp.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcproduct.class).getAttribute(jsdai.SIfc4.CIfcproduct.attributeRepresentation(null), _context))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcramp.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcproduct.class).getAttribute(jsdai.SIfc4.CIfcproduct.attributeRepresentation(null), _context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(_result196), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0))))))).getLogical());
	}
	public int rIfcrampCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRAMPTYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcramp.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
	public int rIfcrampCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcRampTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcRampTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcRampTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcRampTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcRampTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcramp.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
