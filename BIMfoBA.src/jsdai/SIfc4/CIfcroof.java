...
// Java class implementing entity IfcRoof

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcroof extends CIfcbuildingelement implements EIfcroof {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcroof.class, SIfc4.ss);
...
/*
	...
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcRoofTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5612=EXPLICIT_ATTRIBUTE('PredefinedType',#5610,0,#2999,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcroof type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a8 = av.entityValues[5].getEnumeration(0, a8$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcRoof
		av.entityValues[5].setEnumeration(0, a8, a8$);
...
*/
	...
	public int rIfcroofCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcRoofTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcRoofTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcRoofTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcRoofTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcRoofTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcroof.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
	public int rIfcroofCorrectshapedecomposition(SdaiContext _context) throws SdaiException {
																	...
																	Value _internal_aggregate_source263 = Value.alloc(jsdai.SIfc4.CIfcroof.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcproduct.class).getAttribute(jsdai.SIfc4.CIfcproduct.attributeRepresentation(null), _context).getAttribute(jsdai.SIfc4.CIfcproductrepresentation.attributeRepresentations(null), _context);
																	Value _result261 = Value.alloc(_internal_aggregate_source263).create();
																	if (_internal_aggregate_source263.getActualJavaType() != Value.INDETERMINATE) {
																		for (int _i262 = 1; _i262 <= _internal_aggregate_source263.getMemberCount(); _i262++) {
																			Value _implicit_62_temp = _internal_aggregate_source263.getByIndex(_i262);
																			if (Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, _implicit_62_temp.getAttribute("RepresentationIdentifier", _context), Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "Body")).getLogical() == 2) {
																				_result261.addMember(_context, _implicit_62_temp);
																			} else
																			if (_internal_aggregate_source263.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
																				_implicit_62_temp.unset();
																				_result261.addMember(_context, _implicit_62_temp);
																			}
																		}
																	} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).hiIndex(Value.alloc(jsdai.SIfc4.CIfcroof.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeIsdecomposedby(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).hiIndex(Value.alloc(jsdai.SIfc4.CIfcroof.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeIsdecomposedby(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1)), Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcroof.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcproduct.class).getAttribute(jsdai.SIfc4.CIfcproduct.attributeRepresentation(null), _context))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcroof.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcproduct.class).getAttribute(jsdai.SIfc4.CIfcproduct.attributeRepresentation(null), _context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(_result261), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0))))))).getLogical());
	}
}
