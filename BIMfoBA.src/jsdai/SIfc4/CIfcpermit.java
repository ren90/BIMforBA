...
// Java class implementing entity IfcPermit

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcpermit extends CIfccontrol implements EIfcpermit {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcpermit.class, SIfc4.ss);
...
/*
	...
	protected int a6; // PredefinedType - current entity - ENUMERATION IfcPermitTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4891=EXPLICIT_ATTRIBUTE('PredefinedType',#4889,0,#2947,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcpermit type) throws SdaiException {
		return a6$;
	}

	//going through all the attributes: #4892=EXPLICIT_ATTRIBUTE('Status',#4889,1,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeStatus(EIfcpermit type) throws SdaiException {
		return a7$;
	}

	//going through all the attributes: #4893=EXPLICIT_ATTRIBUTE('LongDescription',#4889,2,#2657,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeLongdescription(EIfcpermit type) throws SdaiException {
		return a8$;
	}
