...
// Java class implementing entity IfcOpeningStandardCase

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcopeningstandardcase extends CIfcopeningelement implements EIfcopeningstandardcase {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcopeningstandardcase.class, SIfc4.ss);
...
/*
	...
	// PredefinedType: protected int a8;   PredefinedType - java inheritance - ENUMERATION IfcOpeningElementTypeEnum
	// HasFillings: protected Object  - inverse - java inheritance -  ENTITY IfcRelFillsElement
*/
	...
	// protected int a8;
	// HasFillings - inverse - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4826=EXPLICIT_ATTRIBUTE('PredefinedType',#4824,0,#2939,$,.T.);
	//<01> generating methods for consolidated attribute:  PredefinedType
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4827=INVERSE_ATTRIBUTE('HasFillings',#4824,0,#5474,$,#5476,#8706,$,.F.);
	//<01> generating methods for consolidated attribute:  HasFillings
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcOpeningElement
		av.entityValues[5].setEnumeration(0, a8, a8$);
		// partial entity: IfcOpeningStandardCase
