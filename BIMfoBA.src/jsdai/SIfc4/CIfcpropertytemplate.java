...
// Java class implementing entity IfcPropertyTemplate

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcpropertytemplate extends CIfcpropertytemplatedefinition implements EIfcpropertytemplate {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcpropertytemplate.class, SIfc4.ss);
...
/*
	...
	// PartOfComplexTemplate: protected Object  - inverse - current -  ENTITY IfcComplexPropertyTemplate
	protected static final jsdai.dictionary.CInverse_attribute i2$ = CEntity.initInverseAttribute(definition, 2);
	// PartOfPsetTemplate: protected Object  - inverse - current -  ENTITY IfcPropertySetTemplate
...
*/
	...
	// PartOfComplexTemplate - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i2$ = CEntity.initInverseAttribute(definition, 2);
	// PartOfPsetTemplate - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i3$ = CEntity.initInverseAttribute(definition, 3);
...
*/
	...
	public AIfccomplexpropertytemplate getPartofcomplextemplate(EIfcpropertytemplate type, ASdaiModel domain) throws SdaiException {
		AIfccomplexpropertytemplate result = (AIfccomplexpropertytemplate)get_inverse_aggregate(i2$);
		CIfccomplexpropertytemplate.usedinHaspropertytemplates(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributePartofcomplextemplate(EIfcpropertytemplate type) throws SdaiException {
		return i2$;
	}
	...
	public AIfcpropertysettemplate getPartofpsettemplate(EIfcpropertytemplate type, ASdaiModel domain) throws SdaiException {
		AIfcpropertysettemplate result = (AIfcpropertysettemplate)get_inverse_aggregate(i3$);
		CIfcpropertysettemplate.usedinHaspropertytemplates(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributePartofpsettemplate(EIfcpropertytemplate type) throws SdaiException {
		return i3$;
	}
