...
// Java class implementing entity IfcFireSuppressionTerminal

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcfiresuppressionterminal extends CIfcflowterminal implements EIfcfiresuppressionterminal {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcfiresuppressionterminal.class, SIfc4.ss);
...
/*
	...
	// HasControlElements: protected Object  - inverse - java inheritance -  ENTITY IfcRelFlowControlElements
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcFireSuppressionTerminalTypeEnum
...
*/
	...
	// HasControlElements - inverse - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3978=INVERSE_ATTRIBUTE('HasControlElements',#3976,0,#5478,$,#5481,#8125,#8126,.F.);
	//<01> generating methods for consolidated attribute:  HasControlElements
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4329=EXPLICIT_ATTRIBUTE('PredefinedType',#4327,0,#2873,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcfiresuppressionterminal type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a8 = av.entityValues[3].getEnumeration(0, a8$);
		a4 = av.entityValues[5].getString(0);
		a5 = av.entityValues[7].getInstance(0, this, a5$);
		a6 = av.entityValues[7].getInstance(1, this, a6$);
		a0 = av.entityValues[8].getString(0);
		a1 = av.entityValues[8].getInstance(1, this, a1$);
		a2 = av.entityValues[8].getString(2);
		a3 = av.entityValues[8].getString(3);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcDistributionFlowElement
		// partial entity: IfcElement
		av.entityValues[2].setString(0, a7);
		// partial entity: IfcFireSuppressionTerminal
		av.entityValues[3].setEnumeration(0, a8, a8$);
		// partial entity: IfcFlowTerminal
		// partial entity: IfcObject
		av.entityValues[5].setString(0, a4);
		// partial entity: IfcObjectDefinition
		// partial entity: IfcProduct
		av.entityValues[7].setInstance(0, a5);
		av.entityValues[7].setInstance(1, a6);
		// partial entity: IfcRoot
		av.entityValues[8].setString(0, a0);
		av.entityValues[8].setInstance(1, a1);
		av.entityValues[8].setString(2, a2);
		av.entityValues[8].setString(3, a3);
	}
*/
	...
	public int rIfcfiresuppressionterminalCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCFIRESUPPRESSIONTERMINALTYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcfiresuppressionterminal.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
	public int rIfcfiresuppressionterminalCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFireSuppressionTerminalTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFireSuppressionTerminalTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFireSuppressionTerminalTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFireSuppressionTerminalTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFireSuppressionTerminalTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcfiresuppressionterminal.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
