...
// Java class implementing entity IfcResource

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcresource extends CIfcobject implements EIfcresource {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcresource.class, SIfc4.ss);
...
*/
	...
	public static jsdai.dictionary.EAttribute attributeIdentification(EIfcresource type) throws SdaiException {
		return a5$;
	}
	...
	public static jsdai.dictionary.EAttribute attributeLongdescription(EIfcresource type) throws SdaiException {
		return a6$;
	}
	...
	public AIfcrelassignstoresource getResourceof(EIfcresource type, ASdaiModel domain) throws SdaiException {
		AIfcrelassignstoresource result = (AIfcrelassignstoresource)get_inverse_aggregate(i11$);
		CIfcrelassignstoresource.usedinRelatingresource(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeResourceof(EIfcresource type) throws SdaiException {
		return i11$;
	}
