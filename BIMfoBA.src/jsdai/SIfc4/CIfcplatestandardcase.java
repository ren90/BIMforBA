...
// Java class implementing entity IfcPlateStandardCase

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcplatestandardcase extends CIfcplate implements EIfcplatestandardcase {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcplatestandardcase.class, SIfc4.ss);
...
/*
	...
	// PredefinedType: protected int a8;   PredefinedType - java inheritance - ENUMERATION IfcPlateTypeEnum
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcPlateStandardCase
...
*/
	...
	public int rIfcplatestandardcaseHasmateriallayersetusage(SdaiContext _context) throws SdaiException {
	


									
									Value _internal_aggregate_source143 = Value.alloc(ExpressTypes.BAG_GENERIC_TYPE).usedIn(Value.alloc(jsdai.SIfc4.CIfcplatestandardcase.definition).set(_context, this), Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATES.RELATEDOBJECTS", "IFC4"));
									Value _result141 = Value.alloc(_internal_aggregate_source143).create();
									if (_internal_aggregate_source143.getActualJavaType() != Value.INDETERMINATE) {
										for (int _i142 = 1; _i142 <= _internal_aggregate_source143.getMemberCount(); _i142++) {
											Value _implicit_33_temp = _internal_aggregate_source143.getByIndex(_i142);
											if (Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATESMATERIAL", "IFC4"), _implicit_33_temp.typeOfV(_context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCMATERIALLAYERSETUSAGE", "IFC4"), _implicit_33_temp.getAttribute("RelatingMaterial", _context).typeOfV(_context))).getLogical() == 2) {
												_result141.addMember(_context, _implicit_33_temp);
											} else
											if (_internal_aggregate_source143.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
												_implicit_33_temp.unset();
												_result141.addMember(_context, _implicit_33_temp);
											}
										}
									} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt(_context, _result141), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1))).getLogical());
	}
}
