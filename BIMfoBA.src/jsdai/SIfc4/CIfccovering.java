...
// Java class implementing entity IfcCovering

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfccovering extends CIfcbuildingelement implements EIfccovering {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfccovering.class, SIfc4.ss);
...
/*
	...
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcCoveringTypeEnum
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	// CoversSpaces: protected Object  - inverse - current -  ENTITY IfcRelCoversSpaces
	protected static final jsdai.dictionary.CInverse_attribute i24$ = CEntity.initInverseAttribute(definition, 24);
	// CoversElements: protected Object  - inverse - current -  ENTITY IfcRelCoversBldgElements
	protected static final jsdai.dictionary.CInverse_attribute i25$ = CEntity.initInverseAttribute(definition, 25);
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected int a8;
	// CoversSpaces - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i24$ = CEntity.initInverseAttribute(definition, 24);
	// CoversElements - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i25$ = CEntity.initInverseAttribute(definition, 25);
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3851=EXPLICIT_ATTRIBUTE('PredefinedType',#3849,0,#2793,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfccovering type) throws SdaiException {
		return a8$;
	}

	//going through all the attributes: #3852=INVERSE_ATTRIBUTE('CoversSpaces',#3849,0,#5446,$,#5449,#8040,#8041,.F.);
	//<01> generating methods for consolidated attribute:  CoversSpaces
	//<01-0> current entity
	...
	public AIfcrelcoversspaces getCoversspaces(EIfccovering type, ASdaiModel domain) throws SdaiException {
		AIfcrelcoversspaces result = (AIfcrelcoversspaces)get_inverse_aggregate(i24$);
		CIfcrelcoversspaces.usedinRelatedcoverings(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeCoversspaces(EIfccovering type) throws SdaiException {
		return i24$;
	}

	//going through all the attributes: #3853=INVERSE_ATTRIBUTE('CoversElements',#3849,1,#5442,$,#5445,#8043,#8044,.F.);
	//<01> generating methods for consolidated attribute:  CoversElements
	//<01-0> current entity
	//<01-0-2> inverse attribute - generateInverseCurrentEntityMethodsX()
	public AIfcrelcoversbldgelements getCoverselements(EIfccovering type, ASdaiModel domain) throws SdaiException {
		AIfcrelcoversbldgelements result = (AIfcrelcoversbldgelements)get_inverse_aggregate(i25$);
		CIfcrelcoversbldgelements.usedinRelatedcoverings(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeCoverselements(EIfccovering type) throws SdaiException {
		return i25$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a8 = av.entityValues[1].getEnumeration(0, a8$);
		a7 = av.entityValues[2].getString(0);
		a4 = av.entityValues[3].getString(0);
		a5 = av.entityValues[5].getInstance(0, this, a5$);
		a6 = av.entityValues[5].getInstance(1, this, a6$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcCovering
		av.entityValues[1].setEnumeration(0, a8, a8$);
		// partial entity: IfcElement
		av.entityValues[2].setString(0, a7);
		// partial entity: IfcObject
		av.entityValues[3].setString(0, a4);
		// partial entity: IfcObjectDefinition
		// partial entity: IfcProduct
		av.entityValues[5].setInstance(0, a5);
		av.entityValues[5].setInstance(1, a6);
...
*/
	...
	public int rIfccoveringCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCoveringTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCoveringTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCoveringTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCoveringTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCoveringTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfccovering.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
	public int rIfccoveringCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCCOVERINGTYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfccovering.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
}
