...
// Java class implementing entity IfcProcedure

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcprocedure extends CIfcprocess implements EIfcprocedure {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcprocedure.class, SIfc4.ss);
...
/*
	...
	protected int a7; // PredefinedType - current entity - ENUMERATION IfcProcedureTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5043=EXPLICIT_ATTRIBUTE('PredefinedType',#5041,0,#2961,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcprocedure type) throws SdaiException {
		return a7$;
	}
...
*/
	...
	public int rIfcprocedureCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProcedureTypeEnum).set(_context, get(a7$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProcedureTypeEnum).set(_context, get(a7$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProcedureTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProcedureTypeEnum).set(_context, get(a7$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProcedureTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcprocedure.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
	public int rIfcprocedureHasname(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcprocedure.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcroot.class).getAttribute(jsdai.SIfc4.CIfcroot.attributeName(null), _context))).getLogical());
	}
}
