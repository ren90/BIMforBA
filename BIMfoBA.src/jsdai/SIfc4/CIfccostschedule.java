...
// Java class implementing entity IfcCostSchedule

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfccostschedule extends CIfccontrol implements EIfccostschedule {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfccostschedule.class, SIfc4.ss);
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	protected String a7;
	// SubmittedOn - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected String a8;
	// UpdateDate - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected String a9;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3843=EXPLICIT_ATTRIBUTE('PredefinedType',#3841,0,#2791,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfccostschedule type) throws SdaiException {
		return a6$;
	}

	//going through all the attributes: #3844=EXPLICIT_ATTRIBUTE('Status',#3841,1,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeStatus(EIfccostschedule type) throws SdaiException {
		return a7$;
	}

	//going through all the attributes: #3845=EXPLICIT_ATTRIBUTE('SubmittedOn',#3841,2,#2477,$,.T.);
	//<01> generating methods for consolidated attribute:  SubmittedOn
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeSubmittedon(EIfccostschedule type) throws SdaiException {
		return a8$;
	}

	//going through all the attributes: #3846=EXPLICIT_ATTRIBUTE('UpdateDate',#3841,3,#2477,$,.T.);
	//<01> generating methods for consolidated attribute:  UpdateDate
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeUpdatedate(EIfccostschedule type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a7 = av.entityValues[1].getString(1);
		a8 = av.entityValues[1].getString(2);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcCostSchedule
		av.entityValues[1].setEnumeration(0, a6, a6$);
		av.entityValues[1].setString(1, a7);
		av.entityValues[1].setString(2, a8);
