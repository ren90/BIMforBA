...
// Java class implementing entity IfcWallElementedCase

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcwallelementedcase extends CIfcwall implements EIfcwallelementedcase {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcwallelementedcase.class, SIfc4.ss);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcWallElementedCase
	}
*/
	...
	public int rIfcwallelementedcaseHasdecomposition(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).greater(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).hiIndex(Value.alloc(jsdai.SIfc4.CIfcwallelementedcase.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeIsdecomposedby(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0))).getLogical());
	}
}
