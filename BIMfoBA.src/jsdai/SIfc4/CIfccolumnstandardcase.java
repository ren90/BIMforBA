...
// Java class implementing entity IfcColumnStandardCase

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfccolumnstandardcase extends CIfccolumn implements EIfccolumnstandardcase {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfccolumnstandardcase.class, SIfc4.ss);
...
/*
	...
	// PredefinedType: protected int a8;   PredefinedType - java inheritance - ENUMERATION IfcColumnTypeEnum
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcColumnStandardCase
...
*/
	...
	public int rIfccolumnstandardcaseHasmaterialprofilesetusage(SdaiContext _context) throws SdaiException {
	


									
									Value _internal_aggregate_source64 = Value.alloc(ExpressTypes.BAG_GENERIC_TYPE).usedIn(Value.alloc(jsdai.SIfc4.CIfccolumnstandardcase.definition).set(_context, this), Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATES.RELATEDOBJECTS", "IFC4"));
									Value _result62 = Value.alloc(_internal_aggregate_source64).create();
									if (_internal_aggregate_source64.getActualJavaType() != Value.INDETERMINATE) {
										for (int _i63 = 1; _i63 <= _internal_aggregate_source64.getMemberCount(); _i63++) {
											Value _implicit_15_temp = _internal_aggregate_source64.getByIndex(_i63);
											if (Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATESMATERIAL", "IFC4"), _implicit_15_temp.typeOfV(_context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCMATERIALPROFILESETUSAGE", "IFC4"), _implicit_15_temp.getAttribute("RelatingMaterial", _context).typeOfV(_context))).getLogical() == 2) {
												_result62.addMember(_context, _implicit_15_temp);
											} else
											if (_internal_aggregate_source64.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
												_implicit_15_temp.unset();
												_result62.addMember(_context, _implicit_15_temp);
											}
										}
									} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt(_context, _result62), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1))).getLogical());
	}
}
