...
// Java class implementing entity IfcDoorStyle

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcdoorstyle extends CIfctypeproduct implements EIfcdoorstyle {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcdoorstyle.class, SIfc4.ss);
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a10$ = CEntity.initExplicitAttribute(definition, 10);
	protected int a10;
	// Sizeable - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a11$ = CEntity.initExplicitAttribute(definition, 11);
	protected int a11;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4056=EXPLICIT_ATTRIBUTE('OperationType',#4054,0,#2827,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeOperationtype(EIfcdoorstyle type) throws SdaiException {
		return a8$;
	}

	//going through all the attributes: #4057=EXPLICIT_ATTRIBUTE('ConstructionType',#4054,1,#2825,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeConstructiontype(EIfcdoorstyle type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #4058=EXPLICIT_ATTRIBUTE('ParameterTakesPrecedence',#4054,2,#6,$,.F.);
	...
	public boolean testParametertakesprecedence(EIfcdoorstyle type) throws SdaiException {
		return test_boolean(a10);
	}
	public boolean getParametertakesprecedence(EIfcdoorstyle type) throws SdaiException {
		return get_boolean(a10);
	}
	public void setParametertakesprecedence(EIfcdoorstyle type, boolean value) throws SdaiException {
		a10 = set_boolean(value);
	}
	public void unsetParametertakesprecedence(EIfcdoorstyle type) throws SdaiException {
		a10 = unset_boolean();
	}
	public static jsdai.dictionary.EAttribute attributeParametertakesprecedence(EIfcdoorstyle type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #4059=EXPLICIT_ATTRIBUTE('Sizeable',#4054,3,#6,$,.F.);
	//<01> generating methods for consolidated attribute:  Sizeable
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeSizeable(EIfcdoorstyle type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a9 = av.entityValues[0].getEnumeration(1, a9$);
		a10 = av.entityValues[0].getBoolean(2);
		a11 = av.entityValues[0].getBoolean(3);
		...
		a6 = (AIfcrepresentationmap)av.entityValues[4].getInstanceAggregate(0, a6$, this);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcDoorStyle
		av.entityValues[0].setEnumeration(0, a8, a8$);
		av.entityValues[0].setEnumeration(1, a9, a9$);
		av.entityValues[0].setBoolean(2, a10);
		av.entityValues[0].setBoolean(3, a11);
