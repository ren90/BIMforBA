...
// Java class implementing entity IfcProject

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcproject extends CIfccontext implements EIfcproject {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcproject.class, SIfc4.ss);
...
/*
	...
	// Phase: protected String a6;   Phase - java inheritance - STRING
	// RepresentationContexts: protected AIfcrepresentationcontext a7;   RepresentationContexts - java inheritance - SET OF ENTITY
	// UnitsInContext: protected Object a8;   UnitsInContext - java inheritance - ENTITY IfcUnitAssignment
	// IsDefinedBy: protected Object  - inverse - java inheritance -  ENTITY IfcRelDefinesByProperties
	// Declares: protected Object  - inverse - java inheritance -  ENTITY IfcRelDeclares
*/
	...
	// protected String a5;
	// Phase - explicit - java inheritance
	// protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	// protected String a6;
	// RepresentationContexts - explicit - java inheritance
	// protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	// protected AIfcrepresentationcontext a7;
	// UnitsInContext - explicit - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	// attribute (java explicit): UnitsInContext, base type: entity IfcUnitAssignment
...
*/
	...
	public int rIfcprojectHasownerhistory(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcproject.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcroot.class).getAttribute(jsdai.SIfc4.CIfcroot.attributeOwnerhistory(null), _context))).getLogical());
	}
	public int rIfcprojectCorrectcontext(SdaiContext _context) throws SdaiException {
											...
											Value _internal_aggregate_source174 = Value.alloc(jsdai.SIfc4.CIfcproject.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccontext.class).getAttribute(jsdai.SIfc4.CIfccontext.attributeRepresentationcontexts(null), _context);
											Value _result172 = Value.alloc(_internal_aggregate_source174).create();
											if (_internal_aggregate_source174.getActualJavaType() != Value.INDETERMINATE) {
												for (int _i173 = 1; _i173 <= _internal_aggregate_source174.getMemberCount(); _i173++) {
													Value _implicit_40_Temp = _internal_aggregate_source174.getByIndex(_i173);
													if (Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCGEOMETRICREPRESENTATIONSUBCONTEXT", "IFC4"), _implicit_40_Temp.typeOfV(_context)).getLogical() == 2) {
														_result172.addMember(_context, _implicit_40_Temp);
													} else
													if (_internal_aggregate_source174.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
														_implicit_40_Temp.unset();
														_result172.addMember(_context, _implicit_40_Temp);
													}
												}
											} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcproject.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccontext.class).getAttribute(jsdai.SIfc4.CIfccontext.attributeRepresentationcontexts(null), _context))), Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(_result172), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)))).getLogical());
	}
	public int rIfcprojectHasname(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcproject.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcroot.class).getAttribute(jsdai.SIfc4.CIfcroot.attributeName(null), _context))).getLogical());
	}
	public int rIfcprojectNodecomposition(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt0(_context, Value.alloc(jsdai.SIfc4.CIfcproject.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeDecomposes(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0))).getLogical());
	}
}
