...
// Java class implementing entity IfcProduct

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcproduct extends CIfcobject implements EIfcproduct {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcproduct.class, SIfc4.ss);
...
/*
	...
	protected Object a5; // ObjectPlacement - current entity - ENTITY IfcObjectPlacement
	protected static final jsdai.dictionary.CExplicit_attribute a5$ = CEntity.initExplicitAttribute(definition, 5);
	protected Object a6; // Representation - current entity - ENTITY IfcProductRepresentation
...
*/
	...
	// ObjectPlacement - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a5$ = CEntity.initExplicitAttribute(definition, 5);
	protected Object a5;
	// Representation - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	protected Object a6;
...
*/
	...
	// attribute (current explicit or supertype explicit) : ObjectPlacement, base type: entity IfcObjectPlacement
	...
	public EIfcobjectplacement getObjectplacement(EIfcproduct type) throws SdaiException {
		return (EIfcobjectplacement)get_instance(a5);
	}
	...
	public static jsdai.dictionary.EAttribute attributeObjectplacement(EIfcproduct type) throws SdaiException {
		return a5$;
	}
	...
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// attribute (current explicit or supertype explicit) : Representation, base type: entity IfcProductRepresentation
	...
	public EIfcproductrepresentation getRepresentation(EIfcproduct type) throws SdaiException {
		return (EIfcproductrepresentation)get_instance(a6);
	}
	...
	public static jsdai.dictionary.EAttribute attributeRepresentation(EIfcproduct type) throws SdaiException {
		return a6$;
	}
	...
	public AIfcrelassignstoproduct getReferencedby(EIfcproduct type, ASdaiModel domain) throws SdaiException {
		AIfcrelassignstoproduct result = (AIfcrelassignstoproduct)get_inverse_aggregate(i11$);
		CIfcrelassignstoproduct.usedinRelatingproduct(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeReferencedby(EIfcproduct type) throws SdaiException {
		return i11$;
	}
...
*/
	...
	public int rIfcproductPlacementforshaperepresentation(SdaiContext _context) throws SdaiException {
													...
													Value _internal_aggregate_source166 = Value.alloc(jsdai.SIfc4.CIfcproductrepresentation.definition).set(_context, get(a6$)).getAttribute(jsdai.SIfc4.CIfcproductrepresentation.attributeRepresentations(null), _context);
													Value _result164 = Value.alloc(_internal_aggregate_source166).create();
													if (_internal_aggregate_source166.getActualJavaType() != Value.INDETERMINATE) {
														for (int _i165 = 1; _i165 <= _internal_aggregate_source166.getMemberCount(); _i165++) {
															Value _implicit_38_temp = _internal_aggregate_source166.getByIndex(_i165);
															if (Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSHAPEREPRESENTATION", "IFC4"), _implicit_38_temp.typeOfV(_context)).getLogical() == 2) {
																_result164.addMember(_context, _implicit_38_temp);
															} else
															if (_internal_aggregate_source166.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
																_implicit_38_temp.unset();
																_result164.addMember(_context, _implicit_38_temp);
															}
														}
													} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcproductrepresentation.definition).set(_context, get(a6$))), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcobjectplacement.definition).set(_context, get(a5$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcproductrepresentation.definition).set(_context, get(a6$))), Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(_result164), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcproductrepresentation.definition).set(_context, get(a6$)))))).getLogical());
	}
}
