...
// Java class implementing entity IfcPropertySetDefinition

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcpropertysetdefinition extends CIfcpropertydefinition implements EIfcpropertysetdefinition {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcpropertysetdefinition.class, SIfc4.ss);
...
/*
	...
	// DefinesType: protected Object  - inverse - current -  ENTITY IfcTypeObject
	protected static final jsdai.dictionary.CInverse_attribute i2$ = CEntity.initInverseAttribute(definition, 2);
	// IsDefinedBy: protected Object  - inverse - current -  ENTITY IfcRelDefinesByTemplate
	protected static final jsdai.dictionary.CInverse_attribute i3$ = CEntity.initInverseAttribute(definition, 3);
	// DefinesOccurrence: protected Object  - inverse - current -  ENTITY IfcRelDefinesByProperties
...
*/
	...
	// DefinesType - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i2$ = CEntity.initInverseAttribute(definition, 2);
	// IsDefinedBy - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i3$ = CEntity.initInverseAttribute(definition, 3);
	// DefinesOccurrence - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i4$ = CEntity.initInverseAttribute(definition, 4);
...
*/
	...
	public AIfctypeobject getDefinestype(EIfcpropertysetdefinition type, ASdaiModel domain) throws SdaiException {
		AIfctypeobject result = (AIfctypeobject)get_inverse_aggregate(i2$);
		CIfctypeobject.usedinHaspropertysets(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeDefinestype(EIfcpropertysetdefinition type) throws SdaiException {
		return i2$;
	}
	...
	public AIfcreldefinesbytemplate getIsdefinedby(EIfcpropertysetdefinition type, ASdaiModel domain) throws SdaiException {
		AIfcreldefinesbytemplate result = (AIfcreldefinesbytemplate)get_inverse_aggregate(i3$);
		CIfcreldefinesbytemplate.usedinRelatedpropertysets(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeIsdefinedby(EIfcpropertysetdefinition type) throws SdaiException {
		return i3$;
	}
	...
	public AIfcreldefinesbyproperties getDefinesoccurrence(EIfcpropertysetdefinition type, ASdaiModel domain) throws SdaiException {
		AIfcreldefinesbyproperties result = (AIfcreldefinesbyproperties)get_inverse_aggregate(i4$);
		CIfcreldefinesbyproperties.usedinRelatingpropertydefinition(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeDefinesoccurrence(EIfcpropertysetdefinition type) throws SdaiException {
		return i4$;
	}
