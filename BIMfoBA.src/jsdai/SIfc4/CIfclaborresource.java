...
// Java class implementing entity IfcLaborResource

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfclaborresource extends CIfcconstructionresource implements EIfclaborresource {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfclaborresource.class, SIfc4.ss);
...
/*
	...
	protected int a10; // PredefinedType - current entity - ENUMERATION IfcLaborResourceTypeEnum
...
*/
	...
	//going through all the attributes: #4529=EXPLICIT_ATTRIBUTE('PredefinedType',#4527,0,#2907,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfclaborresource type) throws SdaiException {
		return a10$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a7 = av.entityValues[0].getInstance(0, this, a7$);
		a8 = (AIfcappliedvalue)av.entityValues[0].getInstanceAggregate(1, a8$, this);
		a9 = av.entityValues[0].getInstance(2, this, a9$);
		a10 = av.entityValues[1].getEnumeration(0, a10$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		av.entityValues[0].setInstance(0, a7);
		av.entityValues[0].setInstanceAggregate(1, a8);
		av.entityValues[0].setInstance(2, a9);
		// partial entity: IfcLaborResource
		av.entityValues[1].setEnumeration(0, a10, a10$);
...
*/
	...
	public int rIfclaborresourceCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLaborResourceTypeEnum).set(_context, get(a10$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLaborResourceTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLaborResourceTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLaborResourceTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcLaborResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfclaborresource.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
