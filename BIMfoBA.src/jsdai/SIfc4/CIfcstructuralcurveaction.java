...
// Java class implementing entity IfcStructuralCurveAction

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcstructuralcurveaction extends CIfcstructuralaction implements EIfcstructuralcurveaction {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcstructuralcurveaction.class, SIfc4.ss);
...
/*
	...
	protected int a11; // PredefinedType - current entity - ENUMERATION IfcStructuralCurveActivityTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5817=EXPLICIT_ATTRIBUTE('ProjectedOrTrue',#5815,0,#2967,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeProjectedortrue(EIfcstructuralcurveaction type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #5818=EXPLICIT_ATTRIBUTE('PredefinedType',#5815,1,#3035,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcstructuralcurveaction type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcStructuralCurveAction
...
*/
	...
	public int rIfcstructuralcurveactionSuitablepredefinedtype(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).setEnum(_context, "EQUIDISTANT"))).getLogical());
	}
	public int rIfcstructuralcurveactionProjectedisglobal(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProjectedOrTrueLengthEnum).set(_context, get(a10$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProjectedOrTrueLengthEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcProjectedOrTrueLengthEnum).setEnum(_context, "PROJECTED_LENGTH")), Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.CIfcstructuralcurveaction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcstructuralactivity.class).getAttribute(jsdai.SIfc4.CIfcstructuralactivity.attributeGlobalorlocal(null), _context), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcGlobalOrLocalEnum).setEnum(_context, "GLOBAL_COORDS"))))).getLogical());
	}
	public int rIfcstructuralcurveactionHasobjecttype(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralCurveActivityTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcstructuralcurveaction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context)))).getLogical());
	}
}
