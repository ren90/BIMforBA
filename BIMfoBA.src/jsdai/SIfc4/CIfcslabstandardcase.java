...
// Java class implementing entity IfcSlabStandardCase

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcslabstandardcase extends CIfcslab implements EIfcslabstandardcase {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcslabstandardcase.class, SIfc4.ss);
...
/*
	...
	// PredefinedType: protected int a8;   PredefinedType - java inheritance - ENUMERATION IfcSlabTypeEnum
*/
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5709=EXPLICIT_ATTRIBUTE('PredefinedType',#5707,0,#3017,$,.T.);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcSlab
		av.entityValues[6].setEnumeration(0, a8, a8$);
		// partial entity: IfcSlabStandardCase
	}
*/
	...
	public int rIfcslabstandardcaseHasmateriallayersetusage(SdaiContext _context) throws SdaiException {
	


									
									Value _internal_aggregate_source276 = Value.alloc(ExpressTypes.BAG_GENERIC_TYPE).usedIn(Value.alloc(jsdai.SIfc4.CIfcslabstandardcase.definition).set(_context, this), Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATES.RELATEDOBJECTS", "IFC4"));
									Value _result274 = Value.alloc(_internal_aggregate_source276).create();
									if (_internal_aggregate_source276.getActualJavaType() != Value.INDETERMINATE) {
										for (int _i275 = 1; _i275 <= _internal_aggregate_source276.getMemberCount(); _i275++) {
											Value _implicit_65_temp = _internal_aggregate_source276.getByIndex(_i275);
											if (Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATESMATERIAL", "IFC4"), _implicit_65_temp.typeOfV(_context)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCMATERIALLAYERSETUSAGE", "IFC4"), _implicit_65_temp.getAttribute("RelatingMaterial", _context).typeOfV(_context))).getLogical() == 2) {
												_result274.addMember(_context, _implicit_65_temp);
											} else
											if (_internal_aggregate_source276.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
												_implicit_65_temp.unset();
												_result274.addMember(_context, _implicit_65_temp);
											}
										}
									} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt(_context, _result274), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1))).getLogical());
	}
}
