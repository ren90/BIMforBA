...
// Java class implementing entity IfcProjectOrder

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcprojectorder extends CIfccontrol implements EIfcprojectorder {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcprojectorder.class, SIfc4.ss);
...
/*
	...
	protected int a6; // PredefinedType - current entity - ENUMERATION IfcProjectOrderTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5083=EXPLICIT_ATTRIBUTE('PredefinedType',#5081,0,#2965,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcprojectorder type) throws SdaiException {
		return a6$;
	}

	//going through all the attributes: #5084=EXPLICIT_ATTRIBUTE('Status',#5081,1,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeStatus(EIfcprojectorder type) throws SdaiException {
		return a7$;
	}

	//going through all the attributes: #5085=EXPLICIT_ATTRIBUTE('LongDescription',#5081,2,#2657,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeLongdescription(EIfcprojectorder type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a6 = av.entityValues[3].getEnumeration(0, a6$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcProjectOrder
		av.entityValues[3].setEnumeration(0, a6, a6$);
