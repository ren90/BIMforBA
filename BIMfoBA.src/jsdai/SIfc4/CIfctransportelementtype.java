...
// Java class implementing entity IfcTransportElementType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfctransportelementtype extends CIfcelementtype implements EIfctransportelementtype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfctransportelementtype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcTransportElementTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6245=EXPLICIT_ATTRIBUTE('PredefinedType',#6243,0,#3071,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfctransportelementtype type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcTransportElementType
...
*/
	...
	public int rIfctransportelementtypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
