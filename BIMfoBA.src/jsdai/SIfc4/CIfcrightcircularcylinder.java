...
// Java class implementing entity IfcRightCircularCylinder

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcrightcircularcylinder extends CIfccsgprimitive3d implements EIfcrightcircularcylinder {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcrightcircularcylinder.class, SIfc4.ss);
...
/*
	...
	protected double a2; // Radius - current entity - REAL
...
//###-01 jc.generated_java: Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 3)
	...
	//going through all the attributes: #5608=EXPLICIT_ATTRIBUTE('Height',#5606,0,#2605,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeHeight(EIfcrightcircularcylinder type) throws SdaiException {
		return a1$;
	}

	//going through all the attributes: #5609=EXPLICIT_ATTRIBUTE('Radius',#5606,1,#2605,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeRadius(EIfcrightcircularcylinder type) throws SdaiException {
		return a2$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcRightCircularCylinder
