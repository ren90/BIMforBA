...
// Java class implementing entity IfcRelAssignsToResource

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcrelassignstoresource extends CIfcrelassigns implements EIfcrelassignstoresource {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcrelassignstoresource.class, SIfc4.ss);
...
/*
	...
	protected Object a6; // RelatingResource - current entity - SELECT IfcResourceSelect
...
*/
	...
	// protected int a5;
	// RelatingResource - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	protected Object a6;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5374=EXPLICIT_ATTRIBUTE('RelatingResource',#5372,0,#3189,$,.F.);
	//<01> generating methods for consolidated attribute:  RelatingResource
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// -2- methods for SELECT attribute: RelatingResource
	public static int usedinRelatingresource(EIfcrelassignstoresource type, EEntity instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a6$, domain, result);
	}
	public boolean testRelatingresource(EIfcrelassignstoresource type) throws SdaiException {
		return test_instance(a6);
	}

	public EEntity getRelatingresource(EIfcrelassignstoresource type) throws SdaiException { // case 1
		return get_instance_select(a6);
	}

	public void setRelatingresource(EIfcrelassignstoresource type, EEntity value) throws SdaiException { // case 1
		a6 = set_instance(a6, value);
	}

	public void unsetRelatingresource(EIfcrelassignstoresource type) throws SdaiException {
		a6 = unset_instance(a6);
	}

	public static jsdai.dictionary.EAttribute attributeRelatingresource(EIfcrelassignstoresource type) throws SdaiException {
		return a6$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcRelAssignsToResource
...
*/
	...
	public int rIfcrelassignstoresourceNoselfreference(SdaiContext _context) throws SdaiException {
									...
									Value _internal_aggregate_source226 = Value.alloc(jsdai.SIfc4.CIfcrelassignstoresource.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcrelassigns.class).getAttribute(jsdai.SIfc4.CIfcrelassigns.attributeRelatedobjects(null), _context);
									Value _result224 = Value.alloc(_internal_aggregate_source226).create();
									if (_internal_aggregate_source226.getActualJavaType() != Value.INDETERMINATE) {
										for (int _i225 = 1; _i225 <= _internal_aggregate_source226.getMemberCount(); _i225++) {
											Value _implicit_53_Temp = _internal_aggregate_source226.getByIndex(_i225);
											if (Value.alloc(ExpressTypes.LOGICAL_TYPE).instanceEqual(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcResourceSelect).set(_context, get(a6$)), _implicit_53_Temp).getLogical() == 2) {
												_result224.addMember(_context, _implicit_53_Temp);
											} else
											if (_internal_aggregate_source226.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
												_implicit_53_Temp.unset();
												_result224.addMember(_context, _implicit_53_Temp);
											}
										}
									} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt0(_context, _result224), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0))).getLogical());
	}
}
