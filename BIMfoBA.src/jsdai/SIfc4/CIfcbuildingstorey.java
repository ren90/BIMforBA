...
// Java class implementing entity IfcBuildingStorey

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcbuildingstorey extends CIfcspatialstructureelement implements EIfcbuildingstorey {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcbuildingstorey.class, SIfc4.ss);
...
/*
	...
	protected double a9; // Elevation - current entity - REAL
...
*/
	...
	// protected int a8;
	// Elevation - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected double a9;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3521=EXPLICIT_ATTRIBUTE('Elevation',#3519,0,#2543,$,.T.);
	//<01> generating methods for consolidated attribute:  Elevation
	//<01-0> current entity
	...
	public static jsdai.dictionary.EAttribute attributeElevation(EIfcbuildingstorey type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcBuildingStorey
