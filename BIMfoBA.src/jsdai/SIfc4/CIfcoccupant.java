...
// Java class implementing entity IfcOccupant

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcoccupant extends CIfcactor implements EIfcoccupant {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcoccupant.class, SIfc4.ss);
...
/*
	...
	// TheActor: protected Object a5;   TheActor - java inheritance - SELECT IfcActorSelect
	// IsActingUpon: protected Object  - inverse - java inheritance -  ENTITY IfcRelAssignsToActor
	protected int a6; // PredefinedType - current entity - ENUMERATION IfcOccupantTypeEnum
...
*/
	...
	// TheActor - explicit - java inheritance
	// protected static final jsdai.dictionary.CExplicit_attribute a5$ = CEntity.initExplicitAttribute(definition, 5);
	// protected Object a5;
	// IsActingUpon - inverse - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3236=EXPLICIT_ATTRIBUTE('TheActor',#3234,0,#3111,$,.F.);
	//<01> generating methods for consolidated attribute:  TheActor
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	// -1- methods for SELECT attribute: TheActor
	public static int usedinTheactor(EIfcactor type, EEntity instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a5$, domain, result);
	}
	//going through all the attributes: #3237=INVERSE_ATTRIBUTE('IsActingUpon',#3234,0,#5352,$,#5354,#7522,$,.F.);
	//<01> generating methods for consolidated attribute:  IsActingUpon
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4810=EXPLICIT_ATTRIBUTE('PredefinedType',#4808,0,#2937,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcoccupant type) throws SdaiException {
		return a6$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a5 = av.entityValues[0].getInstance(0, this, a5$);
...
*/
	...
	public int rIfcoccupantWr31(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcOccupantTypeEnum).set(_context, get(a6$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcOccupantTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcoccupant.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context)))).getLogical());
	}
}
