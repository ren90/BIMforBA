...
// Java class implementing entity IfcFixedReferenceSweptAreaSolid

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcfixedreferencesweptareasolid extends CIfcsweptareasolid implements EIfcfixedreferencesweptareasolid {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcfixedreferencesweptareasolid.class, SIfc4.ss);
...
/*
	...
	protected Object a5; // FixedReference - current entity - ENTITY IfcDirection
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a4$ = CEntity.initExplicitAttribute(definition, 4);
	protected double a4;
	// FixedReference - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a5$ = CEntity.initExplicitAttribute(definition, 5);
	protected Object a5;
...
//###-01 jc.generated_java: Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 3)
	...
	//going through all the attributes: #4335=EXPLICIT_ATTRIBUTE('Directrix',#4333,0,#3883,$,.F.);
	...
	public static int usedinDirectrix(EIfcfixedreferencesweptareasolid type, EIfccurve instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static jsdai.dictionary.EAttribute attributeDirectrix(EIfcfixedreferencesweptareasolid type) throws SdaiException {
		return a2$;
	}

	//going through all the attributes: #4336=EXPLICIT_ATTRIBUTE('StartParam',#4333,1,#2599,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeStartparam(EIfcfixedreferencesweptareasolid type) throws SdaiException {
		return a3$;
	}

	//going through all the attributes: #4337=EXPLICIT_ATTRIBUTE('EndParam',#4333,2,#2599,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeEndparam(EIfcfixedreferencesweptareasolid type) throws SdaiException {
		return a4$;
	}

	//going through all the attributes: #4338=EXPLICIT_ATTRIBUTE('FixedReference',#4333,3,#3948,$,.F.);
	//<01> generating methods for consolidated attribute:  FixedReference
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// attribute (current explicit or supertype explicit) : FixedReference, base type: entity IfcDirection
	public static int usedinFixedreference(EIfcfixedreferencesweptareasolid type, EIfcdirection instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static jsdai.dictionary.EAttribute attributeFixedreference(EIfcfixedreferencesweptareasolid type) throws SdaiException {
		return a5$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcFixedReferenceSweptAreaSolid
...
*/
	...
	public int rIfcfixedreferencesweptareasolidDirectrixbounded(SdaiContext _context) throws SdaiException {
											...
											Value _elements112 = Value.alloc(ExpressTypes.AGGREGATE_GENERIC_TYPE).create();
											_elements112.addMember(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCCONIC", "IFC4"));
											_elements112.addMember(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCBOUNDEDCURVE", "IFC4"));
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcParameterValue).set(_context, get(a3$))), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcParameterValue).set(_context, get(a4$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc().mulOrIntersect(_context, _elements112, Value.alloc(jsdai.SIfc4.CIfccurve.definition).set(_context, get(a2$)).typeOfV(_context))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1)))).getLogical());
	}
}
