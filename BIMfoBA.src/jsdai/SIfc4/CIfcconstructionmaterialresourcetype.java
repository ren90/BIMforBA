...
// Java class implementing entity IfcConstructionMaterialResourceType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcconstructionmaterialresourcetype extends CIfcconstructionresourcetype implements EIfcconstructionmaterialresourcetype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcconstructionmaterialresourcetype.class, SIfc4.ss);
...
/*
	...
	protected int a11; // PredefinedType - current entity - ENUMERATION IfcConstructionMaterialResourceTypeEnum
...
*/
	...
	//going through all the attributes: #3767=EXPLICIT_ATTRIBUTE('PredefinedType',#3765,0,#2779,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcconstructionmaterialresourcetype type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcConstructionMaterialResourceType
...
*/
	...
	public int rIfcconstructionmaterialresourcetypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionMaterialResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionMaterialResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionMaterialResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionMaterialResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcconstructionmaterialresourcetype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfctyperesource.class).getAttribute(jsdai.SIfc4.CIfctyperesource.attributeResourcetype(null), _context))))).getLogical());
	}
}
