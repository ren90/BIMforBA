...
// Java class implementing entity IfcMaterialConstituentSet

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcmaterialconstituentset extends CIfcmaterialdefinition implements EIfcmaterialconstituentset {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcmaterialconstituentset.class, SIfc4.ss);
...
/*
	...
	protected AIfcmaterialconstituent a2; // MaterialConstituents - current entity - SET OF ENTITY
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a1$ = CEntity.initExplicitAttribute(definition, 1);
	protected String a1;
	// MaterialConstituents - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a2$ = CEntity.initExplicitAttribute(definition, 2);
	protected AIfcmaterialconstituent a2;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4653=EXPLICIT_ATTRIBUTE('Name',#4651,0,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeName(EIfcmaterialconstituentset type) throws SdaiException {
		return a0$;
	}

	//going through all the attributes: #4654=EXPLICIT_ATTRIBUTE('Description',#4651,1,#2657,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeDescription(EIfcmaterialconstituentset type) throws SdaiException {
		return a1$;
	}

	//going through all the attributes: #4655=EXPLICIT_ATTRIBUTE('MaterialConstituents',#4651,2,#6958,$,.T.);
	//<01> generating methods for consolidated attribute:  MaterialConstituents
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// methods for attribute: MaterialConstituents, base type: SET OF ENTITY
	public static int usedinMaterialconstituents(EIfcmaterialconstituentset type, EIfcmaterialconstituent instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public AIfcmaterialconstituent getMaterialconstituents(EIfcmaterialconstituentset type) throws SdaiException {
		return (AIfcmaterialconstituent)get_aggregate(a2);
	}
	public AIfcmaterialconstituent createMaterialconstituents(EIfcmaterialconstituentset type) throws SdaiException {
		a2 = (AIfcmaterialconstituent)create_aggregate_class(a2, a2$,  AIfcmaterialconstituent.class, 0);
		return a2;
	}
	...
	public static jsdai.dictionary.EAttribute attributeMaterialconstituents(EIfcmaterialconstituentset type) throws SdaiException {
		return a2$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a2 = (AIfcmaterialconstituent)av.entityValues[0].getInstanceAggregate(2, a2$, this);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcMaterialConstituentSet
