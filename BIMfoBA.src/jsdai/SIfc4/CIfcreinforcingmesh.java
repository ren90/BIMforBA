...
// Java class implementing entity IfcReinforcingMesh

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcreinforcingmesh extends CIfcreinforcingelement implements EIfcreinforcingmesh {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcreinforcingmesh.class, SIfc4.ss);
...
*/
	...
	// SteelGrade - explicit - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5317=EXPLICIT_ATTRIBUTE('SteelGrade',#5315,0,#2539,$,.T.);
	//<01> generating methods for consolidated attribute:  SteelGrade
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5322=EXPLICIT_ATTRIBUTE('MeshLength',#5320,0,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeMeshlength(EIfcreinforcingmesh type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #5323=EXPLICIT_ATTRIBUTE('MeshWidth',#5320,1,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeMeshwidth(EIfcreinforcingmesh type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #5324=EXPLICIT_ATTRIBUTE('LongitudinalBarNominalDiameter',#5320,2,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeLongitudinalbarnominaldiameter(EIfcreinforcingmesh type) throws SdaiException {
		return a11$;
	}

	//going through all the attributes: #5325=EXPLICIT_ATTRIBUTE('TransverseBarNominalDiameter',#5320,3,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeTransversebarnominaldiameter(EIfcreinforcingmesh type) throws SdaiException {
		return a12$;
	}

	//going through all the attributes: #5326=EXPLICIT_ATTRIBUTE('LongitudinalBarCrossSectionArea',#5320,4,#2457,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeLongitudinalbarcrosssectionarea(EIfcreinforcingmesh type) throws SdaiException {
		return a13$;
	}

	//going through all the attributes: #5327=EXPLICIT_ATTRIBUTE('TransverseBarCrossSectionArea',#5320,5,#2457,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeTransversebarcrosssectionarea(EIfcreinforcingmesh type) throws SdaiException {
		return a14$;
	}

	//going through all the attributes: #5328=EXPLICIT_ATTRIBUTE('LongitudinalBarSpacing',#5320,6,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeLongitudinalbarspacing(EIfcreinforcingmesh type) throws SdaiException {
		return a15$;
	}

	//going through all the attributes: #5329=EXPLICIT_ATTRIBUTE('TransverseBarSpacing',#5320,7,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeTransversebarspacing(EIfcreinforcingmesh type) throws SdaiException {
		return a16$;
	}

	//going through all the attributes: #5330=EXPLICIT_ATTRIBUTE('PredefinedType',#5320,8,#2995,$,.T.);
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a8 = av.entityValues[5].getString(0);
		a9 = av.entityValues[6].getDouble(0);
		a10 = av.entityValues[6].getDouble(1);
		a11 = av.entityValues[6].getDouble(2);
		a12 = av.entityValues[6].getDouble(3);
		a13 = av.entityValues[6].getDouble(4);
		a14 = av.entityValues[6].getDouble(5);
		a15 = av.entityValues[6].getDouble(6);
		a16 = av.entityValues[6].getDouble(7);
		a17 = av.entityValues[6].getEnumeration(8, a17$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcElementComponent
		...
		// partial entity: IfcReinforcingElement
		av.entityValues[5].setString(0, a8);
		// partial entity: IfcReinforcingMesh
		av.entityValues[6].setDouble(0, a9);
		av.entityValues[6].setDouble(1, a10);
		av.entityValues[6].setDouble(2, a11);
		av.entityValues[6].setDouble(3, a12);
		av.entityValues[6].setDouble(4, a13);
		av.entityValues[6].setDouble(5, a14);
		av.entityValues[6].setDouble(6, a15);
		av.entityValues[6].setDouble(7, a16);
		av.entityValues[6].setEnumeration(8, a17, a17$);
...
*/
	...
	public int rIfcreinforcingmeshCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCREINFORCINGMESHTYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcreinforcingmesh.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
	public int rIfcreinforcingmeshCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcReinforcingMeshTypeEnum).set(_context, get(a17$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcReinforcingMeshTypeEnum).set(_context, get(a17$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcReinforcingMeshTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcReinforcingMeshTypeEnum).set(_context, get(a17$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcReinforcingMeshTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcreinforcingmesh.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
