...
// Java class implementing enumeration IfcCooledBeamTypeEnum

package jsdai.SIfc4;
import jsdai.lang.*;

public class EIfccooledbeamtypeenum {

	private static final int unset = 0;
	public static final int ACTIVE = 1;	// ACTIVE
	public static final int PASSIVE = 2;	// PASSIVE
	public static final int USERDEFINED = 3;	// USERDEFINED
	public static final int NOTDEFINED = 4;	// NOTDEFINED

	private static final int dim = 4;

	public static final String values[] = {"ACTIVE", "PASSIVE", "USERDEFINED", "NOTDEFINED"};
