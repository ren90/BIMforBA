...
// Java class implementing entity IfcBuildingSystem

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcbuildingsystem extends CIfcsystem implements EIfcbuildingsystem {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcbuildingsystem.class, SIfc4.ss);
...
/*
	...
	protected int a5; // PredefinedType - current entity - ENUMERATION IfcBuildingSystemTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3524=EXPLICIT_ATTRIBUTE('PredefinedType',#3522,0,#2743,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcbuildingsystem type) throws SdaiException {
		return a5$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a5 = av.entityValues[0].getEnumeration(0, a5$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcBuildingSystem
		av.entityValues[0].setEnumeration(0, a5, a5$);
