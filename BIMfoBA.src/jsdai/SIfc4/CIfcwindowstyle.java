...
// Java class implementing entity IfcWindowStyle

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcwindowstyle extends CIfctypeproduct implements EIfcwindowstyle {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcwindowstyle.class, SIfc4.ss);
...
/*
	...
	protected int a8; // ConstructionType - current entity - ENUMERATION IfcWindowStyleConstructionEnum
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected int a9; // OperationType - current entity - ENUMERATION IfcWindowStyleOperationEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6398=EXPLICIT_ATTRIBUTE('ConstructionType',#6396,0,#3097,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeConstructiontype(EIfcwindowstyle type) throws SdaiException {
		return a8$;
	}

	//going through all the attributes: #6399=EXPLICIT_ATTRIBUTE('OperationType',#6396,1,#3099,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeOperationtype(EIfcwindowstyle type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #6400=EXPLICIT_ATTRIBUTE('ParameterTakesPrecedence',#6396,2,#6,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeParametertakesprecedence(EIfcwindowstyle type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #6401=EXPLICIT_ATTRIBUTE('Sizeable',#6396,3,#6,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeSizeable(EIfcwindowstyle type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a10 = av.entityValues[4].getBoolean(2);
		a11 = av.entityValues[4].getBoolean(3);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcWindowStyle
		av.entityValues[4].setEnumeration(0, a8, a8$);
		av.entityValues[4].setEnumeration(1, a9, a9$);
		av.entityValues[4].setBoolean(2, a10);
		av.entityValues[4].setBoolean(3, a11);
	}
*/
