...
// Java class implementing entity IfcConstructionEquipmentResourceType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcconstructionequipmentresourcetype extends CIfcconstructionresourcetype implements EIfcconstructionequipmentresourcetype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcconstructionequipmentresourcetype.class, SIfc4.ss);
...
/*
	...
	// BaseCosts: protected AIfcappliedvalue a9;   BaseCosts - java inheritance - LIST OF ENTITY
	// BaseQuantity: protected Object a10;   BaseQuantity - java inheritance - ENTITY IfcPhysicalQuantity
	protected int a11; // PredefinedType - current entity - ENUMERATION IfcConstructionEquipmentResourceTypeEnum
...
*/
	...
	//going through all the attributes: #3761=EXPLICIT_ATTRIBUTE('PredefinedType',#3759,0,#2777,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcconstructionequipmentresourcetype type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a11 = av.entityValues[0].getEnumeration(0, a11$);
		a9 = (AIfcappliedvalue)av.entityValues[1].getInstanceAggregate(0, a9$, this);
		a10 = av.entityValues[1].getInstance(1, this, a10$);
		...
		a6 = av.entityValues[5].getString(0);
		a7 = av.entityValues[5].getString(1);
		a8 = av.entityValues[5].getString(2);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcConstructionEquipmentResourceType
		av.entityValues[0].setEnumeration(0, a11, a11$);
		// partial entity: IfcConstructionResourceType
		av.entityValues[1].setInstanceAggregate(0, a9);
		av.entityValues[1].setInstance(1, a10);
		...
		av.entityValues[5].setString(0, a6);
		av.entityValues[5].setString(1, a7);
		av.entityValues[5].setString(2, a8);
	}
*/
	...
	public int rIfcconstructionequipmentresourcetypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionEquipmentResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionEquipmentResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionEquipmentResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcConstructionEquipmentResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcconstructionequipmentresourcetype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfctyperesource.class).getAttribute(jsdai.SIfc4.CIfctyperesource.attributeResourcetype(null), _context))))).getLogical());
	}
}
