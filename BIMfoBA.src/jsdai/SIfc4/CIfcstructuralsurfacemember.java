...
// Java class implementing entity IfcStructuralSurfaceMember

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcstructuralsurfacemember extends CIfcstructuralmember implements EIfcstructuralsurfacemember {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcstructuralsurfacemember.class, SIfc4.ss);
...
/*
	...
	protected int a7; // PredefinedType - current entity - ENUMERATION IfcStructuralSurfaceMemberTypeEnum
	protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	protected double a8; // Thickness - current entity - REAL
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5927=EXPLICIT_ATTRIBUTE('PredefinedType',#5925,0,#3041,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcstructuralsurfacemember type) throws SdaiException {
		return a7$;
	}

	//going through all the attributes: #5928=EXPLICIT_ATTRIBUTE('Thickness',#5925,1,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeThickness(EIfcstructuralsurfacemember type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a7 = av.entityValues[6].getEnumeration(0, a7$);
		a8 = av.entityValues[6].getDouble(1);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcStructuralSurfaceMember
		av.entityValues[6].setEnumeration(0, a7, a7$);
		av.entityValues[6].setDouble(1, a8);
	}
*/
	...
	public int rIfcstructuralsurfacememberHasobjecttype(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralSurfaceMemberTypeEnum).set(_context, get(a7$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralSurfaceMemberTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcstructuralsurfacemember.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context)))).getLogical());
	}
}
