...
// Java class implementing entity IfcTendonType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfctendontype extends CIfcreinforcingelementtype implements EIfctendontype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfctendontype.class, SIfc4.ss);
...
/*
	...
	protected double a12; // SheethDiameter - current entity - REAL
...
*/
	...
	// SheethDiameter - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a12$ = CEntity.initExplicitAttribute(definition, 12);
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6147=EXPLICIT_ATTRIBUTE('PredefinedType',#6145,0,#3061,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfctendontype type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #6148=EXPLICIT_ATTRIBUTE('NominalDiameter',#6145,1,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeNominaldiameter(EIfctendontype type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #6149=EXPLICIT_ATTRIBUTE('CrossSectionArea',#6145,2,#2457,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeCrosssectionarea(EIfctendontype type) throws SdaiException {
		return a11$;
	}

	//going through all the attributes: #6150=EXPLICIT_ATTRIBUTE('SheethDiameter',#6145,3,#2605,$,.T.);
	//<01> generating methods for consolidated attribute:  SheethDiameter
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeSheethdiameter(EIfctendontype type) throws SdaiException {
		return a12$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a12 = av.entityValues[5].getDouble(3);
...
*/
	...
	public int rIfctendontypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTendonTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTendonTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTendonTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTendonTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfctendontype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
