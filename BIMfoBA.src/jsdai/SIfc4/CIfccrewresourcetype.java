...
// Java class implementing entity IfcCrewResourceType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfccrewresourcetype extends CIfcconstructionresourcetype implements EIfccrewresourcetype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfccrewresourcetype.class, SIfc4.ss);
...
/*
	...
	protected int a11; // PredefinedType - current entity - ENUMERATION IfcCrewResourceTypeEnum
...
*/
	...
	//going through all the attributes: #3862=EXPLICIT_ATTRIBUTE('PredefinedType',#3860,0,#2795,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfccrewresourcetype type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcCrewResourceType
...
*/
	...
	public int rIfccrewresourcetypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCrewResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCrewResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCrewResourceTypeEnum).set(_context, get(a11$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCrewResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfccrewresourcetype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfctyperesource.class).getAttribute(jsdai.SIfc4.CIfctyperesource.attributeResourcetype(null), _context))))).getLogical());
	}
}
