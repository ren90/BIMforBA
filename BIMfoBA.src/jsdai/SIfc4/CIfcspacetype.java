...
// Java class implementing entity IfcSpaceType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcspacetype extends CIfcspatialstructureelementtype implements EIfcspacetype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcspacetype.class, SIfc4.ss);
...
/*
	...
	protected String a10; // LongName - current entity - STRING
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5755=EXPLICIT_ATTRIBUTE('ElementType',#5753,0,#2539,$,.T.);
	//<01> generating methods for consolidated attribute:  ElementType
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5745=EXPLICIT_ATTRIBUTE('PredefinedType',#5743,0,#3023,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcspacetype type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #5746=EXPLICIT_ATTRIBUTE('LongName',#5743,1,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeLongname(EIfcspacetype type) throws SdaiException {
		return a10$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a10 = av.entityValues[2].getString(1);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcSpaceType
		av.entityValues[2].setEnumeration(0, a9, a9$);
		av.entityValues[2].setString(1, a10);
		// partial entity: IfcSpatialElementType
		av.entityValues[3].setString(0, a8);
		// partial entity: IfcSpatialStructureElementType
...
*/
	...
	public int rIfcspacetypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpaceTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpaceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpaceTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcSpaceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcspacetype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcspatialelementtype.class).getAttribute(jsdai.SIfc4.CIfcspatialelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
