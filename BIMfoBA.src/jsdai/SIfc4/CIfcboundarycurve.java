...
// Java class implementing entity IfcBoundaryCurve

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcboundarycurve extends CIfccompositecurveonsurface implements EIfcboundarycurve {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcboundarycurve.class, SIfc4.ss);
...
/*
	...
	// BasisSurface: protected AIfcsurface  - derived - java inheritance -  SET OF ENTITY
...
*/
	...
	// protected static final jsdai.dictionary.CDerived_attribute d2$ = CEntity.initDerivedAttribute(definition, 2);
	// BasisSurface - derived - java inheritance
	// protected static final jsdai.dictionary.CDerived_attribute d3$ = CEntity.initDerivedAttribute(definition, 3);
...
//###-01 jc.generated_java: (new jsdai.SIfc4.FIfccurvedim()).run(_context, Value.alloc(jsdai.SIfc4.CIfcboundarycurve.definition).set(_context, this))
				return ((new jsdai.SIfc4.FIfccurvedim()).run(_context, Value.alloc(jsdai.SIfc4.CIfcboundarycurve.definition).set(_context, this)));
	}
...
//###-01 jc.generated_java: (new jsdai.SIfc4.FIfcgetbasissurface()).run(_context, Value.alloc(jsdai.SIfc4.CIfcboundarycurve.definition).set(_context, this))
				return ((new jsdai.SIfc4.FIfcgetbasissurface()).run(_context, Value.alloc(jsdai.SIfc4.CIfcboundarycurve.definition).set(_context, this)));
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a0 = (AIfccompositecurvesegment)av.entityValues[2].getInstanceAggregate(0, a0$, this);
		a1 = av.entityValues[2].getLogical(1);
	}
*/
...
*/
	...
	public int rIfcboundarycurveIsclosed(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(jsdai.SIfc4.CIfcboundarycurve.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccompositecurve.class).getAttribute(jsdai.SIfc4.CIfccompositecurve.attributeClosedcurve(null), _context)).getLogical());
	}
}
