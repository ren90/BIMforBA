...
// Java class implementing entity IfcWindowType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcwindowtype extends CIfcbuildingelementtype implements EIfcwindowtype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcwindowtype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcWindowTypeEnum
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected int a10; // PartitioningType - current entity - ENUMERATION IfcWindowTypePartitioningEnum
	protected static final jsdai.dictionary.CExplicit_attribute a10$ = CEntity.initExplicitAttribute(definition, 10);
	protected int a11; // ParameterTakesPrecedence - current entity - BOOLEAN
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a10$ = CEntity.initExplicitAttribute(definition, 10);
	protected int a10;
	// ParameterTakesPrecedence - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a11$ = CEntity.initExplicitAttribute(definition, 11);
	protected int a11;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6404=EXPLICIT_ATTRIBUTE('PredefinedType',#6402,0,#3101,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcwindowtype type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #6405=EXPLICIT_ATTRIBUTE('PartitioningType',#6402,1,#3103,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePartitioningtype(EIfcwindowtype type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #6406=EXPLICIT_ATTRIBUTE('ParameterTakesPrecedence',#6402,2,#6,$,.T.);
	//<01> generating methods for consolidated attribute:  ParameterTakesPrecedence
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public boolean testParametertakesprecedence(EIfcwindowtype type) throws SdaiException {
		return test_boolean(a11);
	}
	public boolean getParametertakesprecedence(EIfcwindowtype type) throws SdaiException {
		return get_boolean(a11);
	}
	public void setParametertakesprecedence(EIfcwindowtype type, boolean value) throws SdaiException {
		a11 = set_boolean(value);
	}
	public void unsetParametertakesprecedence(EIfcwindowtype type) throws SdaiException {
		a11 = unset_boolean();
	}
	public static jsdai.dictionary.EAttribute attributeParametertakesprecedence(EIfcwindowtype type) throws SdaiException {
		return a11$;
	}

	//going through all the attributes: #6407=EXPLICIT_ATTRIBUTE('UserDefinedPartitioningType',#6402,3,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeUserdefinedpartitioningtype(EIfcwindowtype type) throws SdaiException {
		return a12$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a5 = (AIfcpropertysetdefinition)av.entityValues[4].getInstanceAggregate(1, a5$, this);
		a6 = (AIfcrepresentationmap)av.entityValues[5].getInstanceAggregate(0, a6$, this);
		a7 = av.entityValues[5].getString(1);
		a9 = av.entityValues[6].getEnumeration(0, a9$);
		a10 = av.entityValues[6].getEnumeration(1, a10$);
		a11 = av.entityValues[6].getBoolean(2);
		a12 = av.entityValues[6].getString(3);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcBuildingElementType
		...
		av.entityValues[4].setInstanceAggregate(1, a5);
		// partial entity: IfcTypeProduct
		av.entityValues[5].setInstanceAggregate(0, a6);
		av.entityValues[5].setString(1, a7);
		// partial entity: IfcWindowType
		av.entityValues[6].setEnumeration(0, a9, a9$);
		av.entityValues[6].setEnumeration(1, a10, a10$);
		av.entityValues[6].setBoolean(2, a11);
		av.entityValues[6].setString(3, a12);
	}
*/
	...
	public int rIfcwindowtypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWindowTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWindowTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWindowTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWindowTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcwindowtype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
