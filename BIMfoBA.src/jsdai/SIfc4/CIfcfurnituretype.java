...
// Java class implementing entity IfcFurnitureType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcfurnituretype extends CIfcfurnishingelementtype implements EIfcfurnituretype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcfurnituretype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // AssemblyPlace - current entity - ENUMERATION IfcAssemblyPlaceEnum
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected int a10; // PredefinedType - current entity - ENUMERATION IfcFurnitureTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4394=EXPLICIT_ATTRIBUTE('AssemblyPlace',#4392,0,#2723,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeAssemblyplace(EIfcfurnituretype type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #4395=EXPLICIT_ATTRIBUTE('PredefinedType',#4392,1,#2883,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcfurnituretype type) throws SdaiException {
		return a10$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a8 = av.entityValues[0].getString(0);
		a9 = av.entityValues[2].getEnumeration(0, a9$);
		a10 = av.entityValues[2].getEnumeration(1, a10$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		av.entityValues[0].setString(0, a8);
		// partial entity: IfcFurnishingElementType
		// partial entity: IfcFurnitureType
		av.entityValues[2].setEnumeration(0, a9, a9$);
		av.entityValues[2].setEnumeration(1, a10, a10$);
...
*/
	...
	public int rIfcfurnituretypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFurnitureTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFurnitureTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFurnitureTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcFurnitureTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcfurnituretype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
