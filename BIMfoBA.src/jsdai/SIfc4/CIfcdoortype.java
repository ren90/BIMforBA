...
// Java class implementing entity IfcDoorType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcdoortype extends CIfcbuildingelementtype implements EIfcdoortype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcdoortype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcDoorTypeEnum
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected int a10; // OperationType - current entity - ENUMERATION IfcDoorTypeOperationEnum
	...
	protected String a12; // UserDefinedOperationType - current entity - STRING
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a11$ = CEntity.initExplicitAttribute(definition, 11);
	protected int a11;
	// UserDefinedOperationType - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a12$ = CEntity.initExplicitAttribute(definition, 12);
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4062=EXPLICIT_ATTRIBUTE('PredefinedType',#4060,0,#2829,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcdoortype type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #4063=EXPLICIT_ATTRIBUTE('OperationType',#4060,1,#2831,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeOperationtype(EIfcdoortype type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #4064=EXPLICIT_ATTRIBUTE('ParameterTakesPrecedence',#4060,2,#6,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeParametertakesprecedence(EIfcdoortype type) throws SdaiException {
		return a11$;
	}

	//going through all the attributes: #4065=EXPLICIT_ATTRIBUTE('UserDefinedOperationType',#4060,3,#2539,$,.T.);
	//<01> generating methods for consolidated attribute:  UserDefinedOperationType
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeUserdefinedoperationtype(EIfcdoortype type) throws SdaiException {
		return a12$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a9 = av.entityValues[1].getEnumeration(0, a9$);
		a10 = av.entityValues[1].getEnumeration(1, a10$);
		a11 = av.entityValues[1].getBoolean(2);
		a12 = av.entityValues[1].getString(3);
		a8 = av.entityValues[2].getString(0);
		...
		a4 = av.entityValues[5].getString(0);
		a5 = (AIfcpropertysetdefinition)av.entityValues[5].getInstanceAggregate(1, a5$, this);
		a6 = (AIfcrepresentationmap)av.entityValues[6].getInstanceAggregate(0, a6$, this);
		a7 = av.entityValues[6].getString(1);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcDoorType
		av.entityValues[1].setEnumeration(0, a9, a9$);
		av.entityValues[1].setEnumeration(1, a10, a10$);
		av.entityValues[1].setBoolean(2, a11);
		av.entityValues[1].setString(3, a12);
		// partial entity: IfcElementType
		av.entityValues[2].setString(0, a8);
		...
		av.entityValues[5].setString(0, a4);
		av.entityValues[5].setInstanceAggregate(1, a5);
		// partial entity: IfcTypeProduct
		av.entityValues[6].setInstanceAggregate(0, a6);
		av.entityValues[6].setString(1, a7);
	}
*/
	...
	public int rIfcdoortypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcDoorTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcDoorTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcDoorTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcDoorTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcdoortype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
