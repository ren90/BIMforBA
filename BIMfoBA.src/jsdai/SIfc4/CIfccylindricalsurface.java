...
// Java class implementing entity IfcCylindricalSurface

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfccylindricalsurface extends CIfcelementarysurface implements EIfccylindricalsurface {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfccylindricalsurface.class, SIfc4.ss);
...
//###-01 jc.generated_java: Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 3)
	...
	//going through all the attributes: #3917=EXPLICIT_ATTRIBUTE('Radius',#3915,0,#2605,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributeRadius(EIfccylindricalsurface type) throws SdaiException {
		return a1$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcCylindricalSurface
