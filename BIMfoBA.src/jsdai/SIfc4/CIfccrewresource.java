...
// Java class implementing entity IfcCrewResource

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfccrewresource extends CIfcconstructionresource implements EIfccrewresource {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfccrewresource.class, SIfc4.ss);
...
/*
	...
	protected int a10; // PredefinedType - current entity - ENUMERATION IfcCrewResourceTypeEnum
...
*/
	...
	//going through all the attributes: #3859=EXPLICIT_ATTRIBUTE('PredefinedType',#3857,0,#2795,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfccrewresource type) throws SdaiException {
		return a10$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcCrewResource
...
*/
	...
	public int rIfccrewresourceCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCrewResourceTypeEnum).set(_context, get(a10$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCrewResourceTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCrewResourceTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCrewResourceTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcCrewResourceTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfccrewresource.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
