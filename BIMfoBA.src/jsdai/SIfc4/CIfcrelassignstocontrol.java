...
// Java class implementing entity IfcRelAssignsToControl

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcrelassignstocontrol extends CIfcrelassigns implements EIfcrelassignstocontrol {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcrelassignstocontrol.class, SIfc4.ss);
...
/*
	...
	protected Object a6; // RelatingControl - current entity - ENTITY IfcControl
...
*/
	...
	// protected int a5;
	// RelatingControl - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	protected Object a6;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5358=EXPLICIT_ATTRIBUTE('RelatingControl',#5356,0,#3796,$,.F.);
	//<01> generating methods for consolidated attribute:  RelatingControl
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	// attribute (current explicit or supertype explicit) : RelatingControl, base type: entity IfcControl
	public static int usedinRelatingcontrol(EIfcrelassignstocontrol type, EIfccontrol instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public EIfccontrol getRelatingcontrol(EIfcrelassignstocontrol type) throws SdaiException {
		return (EIfccontrol)get_instance(a6);
	}
	...
	public static jsdai.dictionary.EAttribute attributeRelatingcontrol(EIfcrelassignstocontrol type) throws SdaiException {
		return a6$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcRelAssignsToControl
...
*/
	...
	public int rIfcrelassignstocontrolNoselfreference(SdaiContext _context) throws SdaiException {
									...
									Value _internal_aggregate_source210 = Value.alloc(jsdai.SIfc4.CIfcrelassignstocontrol.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcrelassigns.class).getAttribute(jsdai.SIfc4.CIfcrelassigns.attributeRelatedobjects(null), _context);
									Value _result208 = Value.alloc(_internal_aggregate_source210).create();
									if (_internal_aggregate_source210.getActualJavaType() != Value.INDETERMINATE) {
										for (int _i209 = 1; _i209 <= _internal_aggregate_source210.getMemberCount(); _i209++) {
											Value _implicit_49_Temp = _internal_aggregate_source210.getByIndex(_i209);
											if (Value.alloc(ExpressTypes.LOGICAL_TYPE).instanceEqual(_context, Value.alloc(jsdai.SIfc4.CIfccontrol.definition).set(_context, get(a6$)), _implicit_49_Temp).getLogical() == 2) {
												_result208.addMember(_context, _implicit_49_Temp);
											} else
											if (_internal_aggregate_source210.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
												_implicit_49_Temp.unset();
												_result208.addMember(_context, _implicit_49_Temp);
											}
										}
									} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt0(_context, _result208), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0))).getLogical());
	}
}
