...
// Java class implementing entity IfcUnitaryControlElement

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcunitarycontrolelement extends CIfcdistributioncontrolelement implements EIfcunitarycontrolelement {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcunitarycontrolelement.class, SIfc4.ss);
...
/*
	...
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcUnitaryControlElementTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6306=EXPLICIT_ATTRIBUTE('PredefinedType',#6304,0,#3079,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcunitarycontrolelement type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a8 = av.entityValues[7].getEnumeration(0, a8$);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcUnitaryControlElement
		av.entityValues[7].setEnumeration(0, a8, a8$);
	}
*/
	...
	public int rIfcunitarycontrolelementCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryControlElementTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryControlElementTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryControlElementTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryControlElementTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryControlElementTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcunitarycontrolelement.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
	public int rIfcunitarycontrolelementCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCUNITARYCONTROLELEMENTTYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcunitarycontrolelement.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
}
