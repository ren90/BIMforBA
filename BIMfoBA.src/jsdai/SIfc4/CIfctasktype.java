...
// Java class implementing entity IfcTaskType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfctasktype extends CIfctypeprocess implements EIfctasktype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfctasktype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcTaskTypeEnum
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected String a10; // WorkMethod - current entity - STRING
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6119=EXPLICIT_ATTRIBUTE('PredefinedType',#6117,0,#3057,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfctasktype type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #6120=EXPLICIT_ATTRIBUTE('WorkMethod',#6117,1,#2539,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeWorkmethod(EIfctasktype type) throws SdaiException {
		return a10$;
	}
...
*/
	...
	public int rIfctasktypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTaskTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTaskTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTaskTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcTaskTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfctasktype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfctypeprocess.class).getAttribute(jsdai.SIfc4.CIfctypeprocess.attributeProcesstype(null), _context))))).getLogical());
	}
}
