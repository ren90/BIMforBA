...
// Java class implementing entity IfcExternalSpatialElement

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcexternalspatialelement extends CIfcexternalspatialstructureelement implements EIfcexternalspatialelement {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcexternalspatialelement.class, SIfc4.ss);
...
/*
	...
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcExternalSpatialElementTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4237=EXPLICIT_ATTRIBUTE('PredefinedType',#4235,0,#2865,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcexternalspatialelement type) throws SdaiException {
		return a8$;
	}

	//going through all the attributes: #4238=INVERSE_ATTRIBUTE('BoundedBy',#4235,0,#5512,$,#5514,#8316,$,.F.);
	...
	public AIfcrelspaceboundary getBoundedby(EIfcexternalspatialelement type, ASdaiModel domain) throws SdaiException {
		AIfcrelspaceboundary result = (AIfcrelspaceboundary)get_inverse_aggregate(i15$);
		CIfcrelspaceboundary.usedinRelatingspace(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeBoundedby(EIfcexternalspatialelement type) throws SdaiException {
		return i15$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a7 = av.entityValues[6].getString(0);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcExternalSpatialElement
		av.entityValues[0].setEnumeration(0, a8, a8$);
		// partial entity: IfcExternalSpatialStructureElement
		...
		av.entityValues[6].setString(0, a7);
	}
*/
