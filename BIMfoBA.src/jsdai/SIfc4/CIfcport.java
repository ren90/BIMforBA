...
// Java class implementing entity IfcPort

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcport extends CIfcproduct implements EIfcport {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcport.class, SIfc4.ss);
...
/*
	...
	// ContainedIn: protected Object  - inverse - current -  ENTITY IfcRelConnectsPortToElement
	protected static final jsdai.dictionary.CInverse_attribute i12$ = CEntity.initInverseAttribute(definition, 12);
	// ConnectedFrom: protected Object  - inverse - current -  ENTITY IfcRelConnectsPorts
	protected static final jsdai.dictionary.CInverse_attribute i13$ = CEntity.initInverseAttribute(definition, 13);
	// ConnectedTo: protected Object  - inverse - current -  ENTITY IfcRelConnectsPorts
...
*/
	...
	// ContainedIn - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i12$ = CEntity.initInverseAttribute(definition, 12);
...
*/
	...
	public AIfcrelconnectsporttoelement getContainedin(EIfcport type, ASdaiModel domain) throws SdaiException {
		AIfcrelconnectsporttoelement result = (AIfcrelconnectsporttoelement)get_inverse_aggregate(i12$);
		CIfcrelconnectsporttoelement.usedinRelatingport(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeContainedin(EIfcport type) throws SdaiException {
		return i12$;
	}
	...
	public AIfcrelconnectsports getConnectedfrom(EIfcport type, ASdaiModel domain) throws SdaiException {
		AIfcrelconnectsports result = (AIfcrelconnectsports)get_inverse_aggregate(i13$);
		CIfcrelconnectsports.usedinRelatedport(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeConnectedfrom(EIfcport type) throws SdaiException {
		return i13$;
	}
	...
	public AIfcrelconnectsports getConnectedto(EIfcport type, ASdaiModel domain) throws SdaiException {
		AIfcrelconnectsports result = (AIfcrelconnectsports)get_inverse_aggregate(i14$);
		CIfcrelconnectsports.usedinRelatingport(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeConnectedto(EIfcport type) throws SdaiException {
		return i14$;
	}
