...
// Java class implementing entity IfcMechanicalFastener

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcmechanicalfastener extends CIfcelementcomponent implements EIfcmechanicalfastener {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcmechanicalfastener.class, SIfc4.ss);
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected double a8;
	// NominalLength - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected double a9;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4738=EXPLICIT_ATTRIBUTE('NominalDiameter',#4736,0,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeNominaldiameter(EIfcmechanicalfastener type) throws SdaiException {
		return a8$;
	}

	//going through all the attributes: #4739=EXPLICIT_ATTRIBUTE('NominalLength',#4736,1,#2605,$,.T.);
	//<01> generating methods for consolidated attribute:  NominalLength
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeNominallength(EIfcmechanicalfastener type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #4740=EXPLICIT_ATTRIBUTE('PredefinedType',#4736,2,#2923,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcmechanicalfastener type) throws SdaiException {
		return a10$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a8 = av.entityValues[2].getDouble(0);
		a9 = av.entityValues[2].getDouble(1);
		a10 = av.entityValues[2].getEnumeration(2, a10$);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcMechanicalFastener
		av.entityValues[2].setDouble(0, a8);
		av.entityValues[2].setDouble(1, a9);
		av.entityValues[2].setEnumeration(2, a10, a10$);
...
*/
	...
	public int rIfcmechanicalfastenerCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcMechanicalFastenerTypeEnum).set(_context, get(a10$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcMechanicalFastenerTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcMechanicalFastenerTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcMechanicalFastenerTypeEnum).set(_context, get(a10$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcMechanicalFastenerTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcmechanicalfastener.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
	public int rIfcmechanicalfastenerCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCMECHANICALFASTENERTYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcmechanicalfastener.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
}
