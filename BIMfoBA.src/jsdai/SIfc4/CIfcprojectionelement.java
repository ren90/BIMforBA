...
// Java class implementing entity IfcProjectionElement

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcprojectionelement extends CIfcfeatureelementaddition implements EIfcprojectionelement {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcprojectionelement.class, SIfc4.ss);
...
/*
	...
	// ProjectsElements: protected Object  - inverse - java inheritance -  ENTITY IfcRelProjectsElement
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcProjectionElementTypeEnum
...
*/
	...
	// ProjectsElements - inverse - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4301=INVERSE_ATTRIBUTE('ProjectsElements',#4299,0,#5493,$,#5496,$,$,.F.);
	//<01> generating methods for consolidated attribute:  ProjectsElements
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5093=EXPLICIT_ATTRIBUTE('PredefinedType',#5091,0,#2969,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcprojectionelement type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcFeatureElementAddition
		...
		// partial entity: IfcProjectionElement
