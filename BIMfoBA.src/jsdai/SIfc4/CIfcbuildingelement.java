...
// Java class implementing entity IfcBuildingElement

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcbuildingelement extends CIfcelement implements EIfcbuildingelement {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcbuildingelement.class, SIfc4.ss);
...
/*
	...
	// HasCoverings: protected Object  - inverse - current -  ENTITY IfcRelCoversBldgElements
...
*/
	...
	public AIfcrelcoversbldgelements getHascoverings(EIfcbuildingelement type, ASdaiModel domain) throws SdaiException {
		AIfcrelcoversbldgelements result = (AIfcrelcoversbldgelements)get_inverse_aggregate(i23$);
		CIfcrelcoversbldgelements.usedinRelatingbuildingelement(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeHascoverings(EIfcbuildingelement type) throws SdaiException {
		return i23$;
	}
...
*/
	...
	public int rIfcbuildingelementMaxonematerialassociation(SdaiContext _context) throws SdaiException {
	



									
									Value _internal_aggregate_source60 = Value.alloc(jsdai.SIfc4.CIfcbuildingelement.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobjectdefinition.class).getAttribute(jsdai.SIfc4.CIfcobjectdefinition.attributeHasassociations(null), _context);
									Value _result58 = Value.alloc(_internal_aggregate_source60).create();
									if (_internal_aggregate_source60.getActualJavaType() != Value.INDETERMINATE) {
										for (int _i59 = 1; _i59 <= _internal_aggregate_source60.getMemberCount(); _i59++) {
											Value _implicit_14_temp = _internal_aggregate_source60.getByIndex(_i59);
											if (Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCRELASSOCIATESMATERIAL", "IFC4"), _implicit_14_temp.typeOfV(_context)).getLogical() == 2) {
												_result58.addMember(_context, _implicit_14_temp);
											} else
											if (_internal_aggregate_source60.getDeclaredType() instanceof jsdai.dictionary.EArray_type) {
												_implicit_14_temp.unset();
												_result58.addMember(_context, _implicit_14_temp);
											}
										}
									} else {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).lequal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt(_context, _result58), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1))).getLogical());
	}
}
