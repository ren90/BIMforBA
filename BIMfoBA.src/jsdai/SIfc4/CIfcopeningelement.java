...
// Java class implementing entity IfcOpeningElement

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcopeningelement extends CIfcfeatureelementsubtraction implements EIfcopeningelement {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcopeningelement.class, SIfc4.ss);
...
/*
	...
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcOpeningElementTypeEnum
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	// HasFillings: protected Object  - inverse - current -  ENTITY IfcRelFillsElement
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected int a8;
	// HasFillings - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i24$ = CEntity.initInverseAttribute(definition, 24);
...
*/
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcopeningelement type) throws SdaiException {
		return a8$;
	}
	...
	public AIfcrelfillselement getHasfillings(EIfcopeningelement type, ASdaiModel domain) throws SdaiException {
		AIfcrelfillselement result = (AIfcrelfillselement)get_inverse_aggregate(i24$);
		CIfcrelfillselement.usedinRelatingopeningelement(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeHasfillings(EIfcopeningelement type) throws SdaiException {
		return i24$;
	}
