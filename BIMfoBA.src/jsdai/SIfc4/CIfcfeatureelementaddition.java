...
// Java class implementing entity IfcFeatureElementAddition

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcfeatureelementaddition extends CIfcfeatureelement implements EIfcfeatureelementaddition {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcfeatureelementaddition.class, SIfc4.ss);
...
/*
	...
	// ProjectsElements: protected Object  - inverse - current -  ENTITY IfcRelProjectsElement
...
*/
	...
	// ProjectsElements - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i23$ = CEntity.initInverseAttribute(definition, 23);
...
*/
	...
	// Inverse attribute - ProjectsElements : IfcRelProjectsElement FOR RelatedFeatureElement
	public AIfcrelprojectselement getProjectselements(EIfcfeatureelementaddition type, ASdaiModel domain) throws SdaiException {
		AIfcrelprojectselement result = new AIfcrelprojectselement();
		CIfcrelprojectselement.usedinRelatedfeatureelement(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeProjectselements(EIfcfeatureelementaddition type) throws SdaiException {
		return i23$;
	}
