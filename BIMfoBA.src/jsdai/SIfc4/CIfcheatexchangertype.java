...
// Java class implementing entity IfcHeatExchangerType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcheatexchangertype extends CIfcenergyconversiondevicetype implements EIfcheatexchangertype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcheatexchangertype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcHeatExchangerTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4460=EXPLICIT_ATTRIBUTE('PredefinedType',#4458,0,#2893,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcheatexchangertype type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcHeatExchangerType
...
*/
	...
	public int rIfcheatexchangertypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcHeatExchangerTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcHeatExchangerTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcHeatExchangerTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcHeatExchangerTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcheatexchangertype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
