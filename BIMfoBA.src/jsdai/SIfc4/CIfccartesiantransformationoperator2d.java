...
// Java class implementing entity IfcCartesianTransformationOperator2D

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfccartesiantransformationoperator2d extends CIfccartesiantransformationoperator implements EIfccartesiantransformationoperator2d {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfccartesiantransformationoperator2d.class, SIfc4.ss);
...
//###-01 jc.generated_java: (new jsdai.SIfc4.FIfcbaseaxis()).run(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 2), Value.alloc(jsdai.SIfc4.CIfccartesiantransformationoperator2d.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccartesiantransformationoperator.class).getAttribute(jsdai.SIfc4.CIfccartesiantransformationoperator.attributeAxis1(null), _context), Value.alloc(jsdai.SIfc4.CIfccartesiantransformationoperator2d.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccartesiantransformationoperator.class).getAttribute(jsdai.SIfc4.CIfccartesiantransformationoperator.attributeAxis2(null), _context), Value.alloc(ExpressTypes.GENERIC_TYPE).unset())
				return ((new jsdai.SIfc4.FIfcbaseaxis()).run(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 2), Value.alloc(jsdai.SIfc4.CIfccartesiantransformationoperator2d.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccartesiantransformationoperator.class).getAttribute(jsdai.SIfc4.CIfccartesiantransformationoperator.attributeAxis1(null), _context), Value.alloc(jsdai.SIfc4.CIfccartesiantransformationoperator2d.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccartesiantransformationoperator.class).getAttribute(jsdai.SIfc4.CIfccartesiantransformationoperator.attributeAxis2(null), _context), Value.alloc(ExpressTypes.GENERIC_TYPE).unset()));
	}
...
*/
	...
	public int rIfccartesiantransformationoperator2dAxis1is2d(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfccartesiantransformationoperator2d.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccartesiantransformationoperator.class).getAttribute(jsdai.SIfc4.CIfccartesiantransformationoperator.attributeAxis1(null), _context))), Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.CIfccartesiantransformationoperator2d.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccartesiantransformationoperator.class).getAttribute(jsdai.SIfc4.CIfccartesiantransformationoperator.attributeAxis1(null), _context).getAttribute(jsdai.SIfc4.CIfcdirection.attributeDim(null), _context), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 2)))).getLogical());
	}
	public int rIfccartesiantransformationoperator2dDimequal2(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.CIfccartesiantransformationoperator2d.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccartesiantransformationoperator.class).getAttribute(jsdai.SIfc4.CIfccartesiantransformationoperator.attributeDim(null), _context), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 2))).getLogical());
	}
	public int rIfccartesiantransformationoperator2dAxis2is2d(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfccartesiantransformationoperator2d.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccartesiantransformationoperator.class).getAttribute(jsdai.SIfc4.CIfccartesiantransformationoperator.attributeAxis2(null), _context))), Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.CIfccartesiantransformationoperator2d.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfccartesiantransformationoperator.class).getAttribute(jsdai.SIfc4.CIfccartesiantransformationoperator.attributeAxis2(null), _context).getAttribute(jsdai.SIfc4.CIfcdirection.attributeDim(null), _context), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 2)))).getLogical());
	}
}
