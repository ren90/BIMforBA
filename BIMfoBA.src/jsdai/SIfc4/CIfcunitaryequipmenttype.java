...
// Java class implementing entity IfcUnitaryEquipmentType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcunitaryequipmenttype extends CIfcenergyconversiondevicetype implements EIfcunitaryequipmenttype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcunitaryequipmenttype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcUnitaryEquipmentTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6315=EXPLICIT_ATTRIBUTE('PredefinedType',#6313,0,#3081,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcunitaryequipmenttype type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a9 = av.entityValues[8].getEnumeration(0, a9$);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcUnitaryEquipmentType
		av.entityValues[8].setEnumeration(0, a9, a9$);
	}
*/
	...
	public int rIfcunitaryequipmenttypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryEquipmentTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryEquipmentTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryEquipmentTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcUnitaryEquipmentTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcunitaryequipmenttype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
