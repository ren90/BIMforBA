...
// Java class implementing entity IfcFeatureElementSubtraction

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcfeatureelementsubtraction extends CIfcfeatureelement implements EIfcfeatureelementsubtraction {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcfeatureelementsubtraction.class, SIfc4.ss);
...
/*
	...
	// VoidsElements: protected Object  - inverse - current -  ENTITY IfcRelVoidsElement
...
*/
	...
	// VoidsElements - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i23$ = CEntity.initInverseAttribute(definition, 23);
...
*/
	...
	public AIfcrelvoidselement getVoidselements(EIfcfeatureelementsubtraction type, ASdaiModel domain) throws SdaiException {
		AIfcrelvoidselement result = new AIfcrelvoidselement();
		CIfcrelvoidselement.usedinRelatedopeningelement(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeVoidselements(EIfcfeatureelementsubtraction type) throws SdaiException {
		return i23$;
	}
...
*/
	...
	public int rIfcfeatureelementsubtractionIsnotfilling(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt0(_context, Value.alloc(jsdai.SIfc4.CIfcfeatureelementsubtraction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelement.class).getAttribute(jsdai.SIfc4.CIfcelement.attributeFillsvoids(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0))).getLogical());
	}
	public int rIfcfeatureelementsubtractionHasnosubtraction(SdaiContext _context) throws SdaiException {
	



		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt0(_context, Value.alloc(jsdai.SIfc4.CIfcfeatureelementsubtraction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelement.class).getAttribute(jsdai.SIfc4.CIfcelement.attributeHasopenings(null), _context)), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0))).getLogical());
	}
}
