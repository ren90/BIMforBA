...
// Java class implementing entity IfcStructuralPointAction

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcstructuralpointaction extends CIfcstructuralaction implements EIfcstructuralpointaction {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcstructuralpointaction.class, SIfc4.ss);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcStructuralPointAction
	}
*/
	...
	public int rIfcstructuralpointactionSuitableloadtype(SdaiContext _context) throws SdaiException {
	



									Value _elements283 = Value.alloc(ExpressTypes.AGGREGATE_GENERIC_TYPE).create();
									_elements283.addMember(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSTRUCTURALLOADSINGLEFORCE", "IFC4"));
									_elements283.addMember(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCSTRUCTURALLOADSINGLEDISPLACEMENT", "IFC4"));
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOfExt(_context, Value.alloc().mulOrIntersect(_context, _elements283, Value.alloc(jsdai.SIfc4.CIfcstructuralpointaction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcstructuralactivity.class).getAttribute(jsdai.SIfc4.CIfcstructuralactivity.attributeAppliedload(null), _context).typeOfV(_context))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1))).getLogical());
	}
}
