...
// Java class implementing entity IfcAirToAirHeatRecovery

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcairtoairheatrecovery extends CIfcenergyconversiondevice implements EIfcairtoairheatrecovery {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcairtoairheatrecovery.class, SIfc4.ss);
...
/*
	...
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcAirToAirHeatRecoveryTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3278=EXPLICIT_ATTRIBUTE('PredefinedType',#3276,0,#2713,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcairtoairheatrecovery type) throws SdaiException {
		return a8$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: IfcAirToAirHeatRecovery
...
*/
	...
	public int rIfcairtoairheatrecoveryCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcAirToAirHeatRecoveryTypeEnum).set(_context, get(a8$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcAirToAirHeatRecoveryTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcAirToAirHeatRecoveryTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcAirToAirHeatRecoveryTypeEnum).set(_context, get(a8$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcAirToAirHeatRecoveryTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcairtoairheatrecovery.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
