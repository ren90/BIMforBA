...
// Java class implementing entity IfcWorkSchedule

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcworkschedule extends CIfcworkcontrol implements EIfcworkschedule {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcworkschedule.class, SIfc4.ss);
...
/*
	...
	protected int a13; // PredefinedType - current entity - ENUMERATION IfcWorkScheduleTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6427=EXPLICIT_ATTRIBUTE('PredefinedType',#6425,0,#3109,$,.T.);
	...
	public boolean testPredefinedtype(EIfcworkschedule type) throws SdaiException {
		return test_enumeration(a13);
	}
	public int getPredefinedtype(EIfcworkschedule type) throws SdaiException {
		return get_enumeration(a13);
	}
	public void setPredefinedtype(EIfcworkschedule type, int value) throws SdaiException {
		a13 = set_enumeration(value, a13$);
	}
	public void unsetPredefinedtype(EIfcworkschedule type) throws SdaiException {
		a13 = unset_enumeration();
	}
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcworkschedule type) throws SdaiException {
		return a13$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcWorkSchedule
...
*/
	...
	public int rIfcworkscheduleCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkScheduleTypeEnum).set(_context, get(a13$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkScheduleTypeEnum).set(_context, get(a13$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkScheduleTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkScheduleTypeEnum).set(_context, get(a13$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkScheduleTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcworkschedule.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
