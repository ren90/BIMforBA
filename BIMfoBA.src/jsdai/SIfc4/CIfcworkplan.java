...
// Java class implementing entity IfcWorkPlan

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcworkplan extends CIfcworkcontrol implements EIfcworkplan {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcworkplan.class, SIfc4.ss);
...
/*
	...
	// CreationDate: protected String a6;   CreationDate - java inheritance - STRING
	// Creators: protected AIfcperson a7;   Creators - java inheritance - SET OF ENTITY
	// Purpose: protected String a8;   Purpose - java inheritance - STRING
	// Duration: protected String a9;   Duration - java inheritance - STRING
	// TotalFloat: protected String a10;   TotalFloat - java inheritance - STRING
	// StartTime: protected String a11;   StartTime - java inheritance - STRING
	// FinishTime: protected String a12;   FinishTime - java inheritance - STRING
	protected int a13; // PredefinedType - current entity - ENUMERATION IfcWorkPlanTypeEnum
...
*/
	...
	// CreationDate - explicit - java inheritance
	// protected static final jsdai.dictionary.CExplicit_attribute a6$ = CEntity.initExplicitAttribute(definition, 6);
	// protected String a6;
	// Creators - explicit - java inheritance
	...
	// protected String a8;
	// Duration - explicit - java inheritance
	...
	// FinishTime - explicit - java inheritance
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #6424=EXPLICIT_ATTRIBUTE('PredefinedType',#6422,0,#3107,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcworkplan type) throws SdaiException {
		return a13$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a13 = av.entityValues[5].getEnumeration(0, a13$);
	}
*/
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcWorkPlan
		av.entityValues[5].setEnumeration(0, a13, a13$);
	}
*/
	...
	public int rIfcworkplanCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkPlanTypeEnum).set(_context, get(a13$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkPlanTypeEnum).set(_context, get(a13$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkPlanTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkPlanTypeEnum).set(_context, get(a13$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcWorkPlanTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcworkplan.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
}
