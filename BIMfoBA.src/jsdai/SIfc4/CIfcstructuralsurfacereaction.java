...
// Java class implementing entity IfcStructuralSurfaceReaction

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcstructuralsurfacereaction extends CIfcstructuralreaction implements EIfcstructuralsurfacereaction {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcstructuralsurfacereaction.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcStructuralSurfaceActivityTypeEnum
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5933=EXPLICIT_ATTRIBUTE('PredefinedType',#5931,0,#3039,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcstructuralsurfacereaction type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcStructuralSurfaceReaction
...
*/
	...
	public int rIfcstructuralsurfacereactionHaspredefinedtype(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralSurfaceActivityTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcStructuralSurfaceActivityTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcstructuralsurfacereaction.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context)))).getLogical());
	}
}
