...
// Java class implementing entity IfcDistributionPort

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcdistributionport extends CIfcport implements EIfcdistributionport {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcdistributionport.class, SIfc4.ss);
...
/*
	...
	// ContainedIn: protected Object  - inverse - java inheritance -  ENTITY IfcRelConnectsPortToElement
	// ConnectedFrom: protected Object  - inverse - java inheritance -  ENTITY IfcRelConnectsPorts
	// ConnectedTo: protected Object  - inverse - java inheritance -  ENTITY IfcRelConnectsPorts
	protected int a7; // FlowDirection - current entity - ENUMERATION IfcFlowDirectionEnum
	protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	protected int a8; // PredefinedType - current entity - ENUMERATION IfcDistributionPortTypeEnum
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected int a9; // SystemType - current entity - ENUMERATION IfcDistributionSystemEnum
...
*/
	...
	// ContainedIn - inverse - java inheritance
	...
	// FlowDirection - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	protected int a7;
	// PredefinedType - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected int a8;
	// SystemType - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a9$ = CEntity.initExplicitAttribute(definition, 9);
	protected int a9;
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4996=INVERSE_ATTRIBUTE('ContainedIn',#4994,0,#5410,$,#5412,#8824,#8825,.F.);
	//<01> generating methods for consolidated attribute:  ContainedIn
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4997=INVERSE_ATTRIBUTE('ConnectedFrom',#4994,1,#5414,$,#5417,#8827,#8828,.F.);
	//<01> generating methods for consolidated attribute:  ConnectedFrom
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4998=INVERSE_ATTRIBUTE('ConnectedTo',#4994,2,#5414,$,#5416,#8830,#8831,.F.);
	//<01> generating methods for consolidated attribute:  ConnectedTo
	//<01-1> supertype, java inheritance
	//<01-1-2> inverse - generateInverseSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #3983=EXPLICIT_ATTRIBUTE('FlowDirection',#3981,0,#2875,$,.T.);
	//<01> generating methods for consolidated attribute:  FlowDirection
	//<01-0> current entity
	...
	public static jsdai.dictionary.EAttribute attributeFlowdirection(EIfcdistributionport type) throws SdaiException {
		return a7$;
	}

	//going through all the attributes: #3984=EXPLICIT_ATTRIBUTE('PredefinedType',#3981,1,#2813,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcdistributionport type) throws SdaiException {
		return a8$;
	}

	//going through all the attributes: #3985=EXPLICIT_ATTRIBUTE('SystemType',#3981,2,#2815,$,.T.);
	//<01> generating methods for consolidated attribute:  SystemType
	//<01-0> current entity
	//<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
	...
	public static jsdai.dictionary.EAttribute attributeSystemtype(EIfcdistributionport type) throws SdaiException {
		return a9$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a9 = av.entityValues[0].getEnumeration(2, a9$);
