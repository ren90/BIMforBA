...
// Java class implementing entity IfcTypeResource

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfctyperesource extends CIfctypeobject implements EIfctyperesource {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfctyperesource.class, SIfc4.ss);
...
/*
	...
	protected String a8; // ResourceType - current entity - STRING
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	// ResourceOf: protected Object  - inverse - current -  ENTITY IfcRelAssignsToResource
...
*/
	...
	protected static final jsdai.dictionary.CExplicit_attribute a7$ = CEntity.initExplicitAttribute(definition, 7);
	protected String a7;
	// ResourceType - explicit - current entity
	protected static final jsdai.dictionary.CExplicit_attribute a8$ = CEntity.initExplicitAttribute(definition, 8);
	protected String a8;
	// ResourceOf - inverse - current entity
	protected static final jsdai.dictionary.CInverse_attribute i8$ = CEntity.initInverseAttribute(definition, 8);
...
*/
	...
	public static jsdai.dictionary.EAttribute attributeIdentification(EIfctyperesource type) throws SdaiException {
		return a6$;
	}
	...
	public static jsdai.dictionary.EAttribute attributeLongdescription(EIfctyperesource type) throws SdaiException {
		return a7$;
	}
	...
	public static jsdai.dictionary.EAttribute attributeResourcetype(EIfctyperesource type) throws SdaiException {
		return a8$;
	}
	...
	public AIfcrelassignstoresource getResourceof(EIfctyperesource type, ASdaiModel domain) throws SdaiException {
		AIfcrelassignstoresource result = (AIfcrelassignstoresource)get_inverse_aggregate(i8$);
		CIfcrelassignstoresource.usedinRelatingresource(null, this, domain, result);
		return result;
	}
	public static jsdai.dictionary.EAttribute attributeResourceof(EIfctyperesource type) throws SdaiException {
		return i8$;
	}
