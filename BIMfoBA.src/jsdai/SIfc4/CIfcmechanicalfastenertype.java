...
// Java class implementing entity IfcMechanicalFastenerType

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcmechanicalfastenertype extends CIfcelementcomponenttype implements EIfcmechanicalfastenertype {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcmechanicalfastenertype.class, SIfc4.ss);
...
/*
	...
	protected int a9; // PredefinedType - current entity - ENUMERATION IfcMechanicalFastenerTypeEnum
	...
	protected double a11; // NominalLength - current entity - REAL
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #4743=EXPLICIT_ATTRIBUTE('PredefinedType',#4741,0,#2923,$,.F.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcmechanicalfastenertype type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #4744=EXPLICIT_ATTRIBUTE('NominalDiameter',#4741,1,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeNominaldiameter(EIfcmechanicalfastenertype type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #4745=EXPLICIT_ATTRIBUTE('NominalLength',#4741,2,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeNominallength(EIfcmechanicalfastenertype type) throws SdaiException {
		return a11$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a10 = av.entityValues[2].getDouble(1);
		a11 = av.entityValues[2].getDouble(2);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcMechanicalFastenerType
		av.entityValues[2].setEnumeration(0, a9, a9$);
		av.entityValues[2].setDouble(1, a10);
		av.entityValues[2].setDouble(2, a11);
...
*/
	...
	public int rIfcmechanicalfastenertypeCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcMechanicalFastenerTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcMechanicalFastenerTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcMechanicalFastenerTypeEnum).set(_context, get(a9$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcMechanicalFastenerTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcmechanicalfastenertype.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcelementtype.class).getAttribute(jsdai.SIfc4.CIfcelementtype.attributeElementtype(null), _context))))).getLogical());
	}
}
