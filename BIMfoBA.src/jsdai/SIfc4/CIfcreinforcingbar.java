...
// Java class implementing entity IfcReinforcingBar

package jsdai.SIfc4;
import jsdai.lang.*;

public class CIfcreinforcingbar extends CIfcreinforcingelement implements EIfcreinforcingbar {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CIfcreinforcingbar.class, SIfc4.ss);
...
*/
	...
	//<01-1> supertype, java inheritance
	//<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
	//going through all the attributes: #5301=EXPLICIT_ATTRIBUTE('NominalDiameter',#5299,0,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeNominaldiameter(EIfcreinforcingbar type) throws SdaiException {
		return a9$;
	}

	//going through all the attributes: #5302=EXPLICIT_ATTRIBUTE('CrossSectionArea',#5299,1,#2457,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeCrosssectionarea(EIfcreinforcingbar type) throws SdaiException {
		return a10$;
	}

	//going through all the attributes: #5303=EXPLICIT_ATTRIBUTE('BarLength',#5299,2,#2605,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeBarlength(EIfcreinforcingbar type) throws SdaiException {
		return a11$;
	}

	//going through all the attributes: #5304=EXPLICIT_ATTRIBUTE('PredefinedType',#5299,3,#2993,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributePredefinedtype(EIfcreinforcingbar type) throws SdaiException {
		return a12$;
	}

	//going through all the attributes: #5305=EXPLICIT_ATTRIBUTE('BarSurface',#5299,4,#2991,$,.T.);
	...
	public static jsdai.dictionary.EAttribute attributeBarsurface(EIfcreinforcingbar type) throws SdaiException {
		return a13$;
	}
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a9 = av.entityValues[5].getDouble(0);
		a10 = av.entityValues[5].getDouble(1);
		a11 = av.entityValues[5].getDouble(2);
		a12 = av.entityValues[5].getEnumeration(3, a12$);
		a13 = av.entityValues[5].getEnumeration(4, a13$);
		a8 = av.entityValues[6].getString(0);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: IfcReinforcingBar
		av.entityValues[5].setDouble(0, a9);
		av.entityValues[5].setDouble(1, a10);
		av.entityValues[5].setDouble(2, a11);
		av.entityValues[5].setEnumeration(3, a12, a12$);
		av.entityValues[5].setEnumeration(4, a13, a13$);
		// partial entity: IfcReinforcingElement
		av.entityValues[6].setString(0, a8);
...
*/
	...
	public int rIfcreinforcingbarCorrectpredefinedtype(SdaiContext _context) throws SdaiException {
		...
		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).NOT(Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.SIfc4._st_IfcReinforcingBarTypeEnum).set(_context, get(a12$)))), Value.alloc(ExpressTypes.LOGICAL_TYPE).nequal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcReinforcingBarTypeEnum).set(_context, get(a12$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcReinforcingBarTypeEnum).setEnum(_context, "USERDEFINED"))), Value.alloc(ExpressTypes.LOGICAL_TYPE).AND(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(jsdai.SIfc4.SIfc4._st_IfcReinforcingBarTypeEnum).set(_context, get(a12$)), Value.alloc(jsdai.SIfc4.SIfc4._st_IfcReinforcingBarTypeEnum).setEnum(_context, "USERDEFINED")), Value.alloc(ExpressTypes.BOOLEAN_TYPE).exists(Value.alloc(jsdai.SIfc4.CIfcreinforcingbar.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeObjecttype(null), _context))))).getLogical());
	}
	public int rIfcreinforcingbarCorrecttypeassigned(SdaiContext _context) throws SdaiException {
	




		return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).equal(_context, Value.alloc(ExpressTypes.INTEGER_TYPE).sizeOf(Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(jsdai.SIfc4.CIfcobject.attributeIstypedby(null)))), Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 0)), Value.alloc(ExpressTypes.LOGICAL_TYPE).IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.IFCREINFORCINGBARTYPE", "IFC4"), Value.alloc(jsdai.SIfc4.CIfcreinforcingbar.definition).set(_context, this).groupReference(_context, jsdai.SIfc4.CIfcobject.class).getAttribute(jsdai.SIfc4.CIfcobject.attributeIstypedby(null), _context).indexing(Value.alloc(ExpressTypes.INTEGER_TYPE).set(_context, 1), null).getAttribute("RelatingType", _context).typeOfV(_context)))).getLogical());
	}
}
